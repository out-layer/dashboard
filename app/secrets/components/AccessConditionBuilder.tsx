...
export function AccessConditionBuilder({ condition, onChange }: AccessConditionBuilderProps) {
 ...
 className="block w-full max-w-xl rounded-md border border-border-strong px-3 py-2 text-sm outline-none focus:border-accent focus:ring-1 focus:ring-accent font-mono"
          />
 ...
 className="block w-32 rounded-md border border-border-strong px-3 py-2 text-sm outline-none focus:border-accent focus:ring-1 focus:ring-accent"
            >
              {operators.map(op => (
            ...
            <input
              ...
              placeholder="1.0"
 className="block flex-1 rounded-md border border-border-strong px-3 py-2 text-sm outline-none focus:border-accent focus:ring-1 focus:ring-accent"
            />
 ...
 className="block w-32 rounded-md border border-border-strong px-3 py-2 text-sm outline-none focus:border-accent focus:ring-1 focus:ring-accent"
              ...
              <input
                ...
                placeholder="1000000"
 className="block flex-1 rounded-md border border-border-strong px-3 py-2 text-sm outline-none focus:border-accent focus:ring-1 focus:ring-accent font-mono"
              />
            </div>
 <p className="mt-1 text-xs text-muted-foreground">
