...
export default function GettingStartedSection() {
 ...
 <div className="bg-card-muted border-l-4 border-border p-3">
 <p className="text-sm text-foreground"><strong> Code Integrity</strong> - SHA256 of exact WASM binary</p>
            </div>
 <div className="bg-card-muted border-l-4 border-border p-3">
 <p className="text-sm text-foreground"><strong> Input Integrity</strong> - SHA256 of input data</p>
            </div>
 <div className="bg-card-muted border-l-4 border-border p-3">
 <p className="text-sm text-foreground"><strong> Output Integrity</strong> - Result from that code + input</p>
            </div>
 <div className="bg-card-muted border-l-4 border-border p-3">
 <p className="text-sm text-foreground"><strong> Worker Identity</strong> - Verified TEE measurements</p>
            </div>
          </div>
 ...
 <div className="bg-card-muted border-2 border-border rounded-lg p-4 mb-3">
 <p className="text-sm text-foreground">
 ...
 <div className="bg-card-muted border-l-4 border-border p-4">
 <p className="text-sm text-foreground">
 <Link href="/docs/secrets#confidential-key-derivation" className="underline font-medium">CKD Documentation</Link> • <Link href="/docs/secrets#dao-governance" className="underline font-medium">DAO Governance →</Link>
            </p>
          </div>
        </section>
 ...
 <div className="bg-card-muted border-2 border-border rounded-lg p-5">
 <h4 className="font-bold text-foreground mb-2 text-lg"> Blockchain (NEAR)</h4>
 ...
 <Link href="/docs/near-integration" className="text-sm text-muted-foreground font-medium hover:underline">
                Full documentation →
              </Link>
            </div>
 <div className="bg-card-muted border-2 border-border rounded-lg p-5">
 <h4 className="font-bold text-foreground mb-2 text-lg"> HTTPS API</h4>
 <ul className="text-sm text-foreground space-y-1 mb-3">
 ...
 <Link href="/docs/web2-integration" className="text-sm text-muted-foreground font-medium hover:underline">
                Full documentation →
              </Link>
            </div>
          </div>
 ...
 <div className="flex-shrink-0 w-8 h-8 bg-card-muted0 rounded-full flex items-center justify-center text-white font-bold text-xs">1</div>
 ...
 <div className="font-bold text-foreground text-xs">⏸ YIELD - Transaction paused</div>
              </div>
 ...
 <div className="font-bold text-foreground text-xs mb-1"> Off-chain work:</div>
 ...
 <div className="ml-10 p-3 bg-card-muted border-l-4 border-green-600 rounded">
 <div className="font-bold text-foreground text-xs">Return execution output</div>
              </div>
 ...
 <span className="font-semibold text-foreground">Contract</span>
              ...
              {/* RESUME */}
 <div className="ml-10 p-3 bg-card-muted border-l-4 border-green-600 rounded">
 <div className="font-bold text-foreground text-xs">▶ RESUME - Process result in callback</div>
              </div>

              {/* Complete */}
 <div className="p-3 bg-card-muted border-2 border-green-600 rounded-lg text-center">
 <div className="font-bold text-foreground text-xs"> Transaction Complete!</div>
 <div className="text-xs text-foreground mt-1">User receives final result</div>
              </div>
            </div>
          </div>
 ...
 <text x="250" y="362" textAnchor="middle" fontSize="11" fontWeight="bold" fill="#166534"> Instant response with verifiable proof</text>
          ...
          {/* Mobile Simplified Diagram */}
 <div className="md:hidden bg-gradient-to-b from-card-muted to-card-muted border-2 border-border-strong rounded-lg p-4 mb-4">
 <div className="space-y-3 text-sm">
              {/* Step 1 */}
 <div className="flex items-center gap-2">
 <div className="flex-shrink-0 w-8 h-8 bg-card-muted0 rounded-full flex items-center justify-center text-white font-bold text-xs">1</div>
 ...
 <span className="text-muted-foreground">→</span>
 <span className="font-semibold text-foreground">OutLayer API</span>
                  </div>
 ...
 <span className="text-muted-foreground">→</span>
 <span className="font-semibold text-foreground">TEE Worker</span>
                </div>
              </div>

              {/* Execution */}
 <div className="ml-10 p-3 bg-card-muted border-l-4 border-border rounded">
 <div className="font-bold text-foreground text-xs mb-1"> TEE execution:</div>
 <div className="text-xs text-foreground space-y-0.5">
 ...
 <span className="font-semibold text-foreground">App</span>
              ...
              {/* Complete */}
 <div className="p-3 bg-card-muted border-2 border-green-600 rounded-lg text-center">
 <div className="font-bold text-foreground text-xs"> Instant Response!</div>
 <div className="text-xs text-foreground mt-1">JSON with result + attestation proof</div>
              </div>
            </div>
          </div>
 ...
 Optionally send payment to app author via <code className="bg-card-muted px-1 rounded text-xs">X-Attached-Deposit</code> header.
            </p>
          </div>
        </section>
 ...
 <div className="bg-card-muted p-4 rounded-lg border-l-4 border-border">
 <p className="text-sm text-foreground">
...
{`near call outlayer.testnet request_execution '\\
 ...
 <div className="bg-card-muted border-l-4 border-border p-4">
 <p className="text-sm text-foreground">
 <Link href="/secrets" className="underline font-medium">Manage Secrets</Link> • <Link href="/docs/secrets#confidential-key-derivation" className="underline font-medium">CKD Docs</Link> • <Link href="/docs/secrets" className="underline font-medium">Learn more →</Link>
            </p>
          </div>
        </section>
 ...
 <div className="bg-card-muted border-l-4 border-border p-4">
 <p className="text-sm text-foreground">
 <Link href="/docs/storage" className="underline font-medium">Storage Guide</Link> • <Link href="/docs/projects" className="underline font-medium">Projects →</Link>
            </p>
          </div>
        </section>
 ...
 <Link href="/docs/dev-guide" className="block bg-gradient-to-br from-card-muted to-red-50 border-2 border-border rounded-lg p-4 hover:shadow-lg transition-shadow">
 ...
 <Link href="/docs/examples" className="block bg-gradient-to-br from-blue-50 to-card-muted border-2 border-border rounded-lg p-4 hover:shadow-lg transition-shadow">
 ...
 <Link href="/docs/near-integration" className="block bg-gradient-to-br from-green-50 to-card-muted border-2 border-border rounded-lg p-4 hover:shadow-lg transition-shadow">
