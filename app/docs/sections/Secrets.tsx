...
export default function SecretsSection() {
 ...
 <li className="text-muted-foreground">Cannot use <code className="bg-card-muted px-1 rounded">PROTECTED_*</code> prefix (reserved for auto-generated)</li>
                </ul>
              </div>
 ...
 <li className="text-foreground">Must start with <code className="bg-card-muted px-1 rounded">PROTECTED_*</code> prefix (proves TEE generation)</li>
 ...
 <p className="text-sm text-foreground font-medium mb-1">Naming Convention for Trust</p>
 <p className="text-xs text-foreground">
 The <code className="bg-card-muted px-1 rounded">PROTECTED_*</code> prefix proves a secret was generated in TEE and never seen by anyone (including developers).
 ...
 <li className="text-muted-foreground"><strong>Wildcard:</strong> Leave branch empty for secrets not tied to a specific branch</li>
              </ul>
            </div>
 ...
 <div id="project-binding" className="border-l-4 border-border pl-3 scroll-mt-4">
 ...
 <div className="mt-3 p-3 bg-card-muted border border-border rounded">
 <p className="text-sm text-foreground font-medium mb-1">Project Binding Recommendation</p>
 <p className="text-xs text-foreground">
 ...
 <div className="bg-card-muted p-4 rounded-lg border-2 border-border">
 <h4 className="font-bold text-foreground mb-3">Phase 1: Registration (One-time)</h4>
...
└──────────┘`}</pre>
                ...
                {/* Phase 2: CKD Flow */}
 <div className="bg-card-muted p-4 rounded-lg border-2 border-border">
 <h4 className="font-bold text-foreground mb-3">Phase 2: CKD Flow (Repeatable)</h4>
...
└──────────┘`}</pre>
                ...
                {/* Key Properties */}
 <div className="bg-card-muted p-3 rounded-lg border border-border">
 <h4 className="font-semibold text-foreground mb-2 text-sm">Key Properties</h4>
 ...
 <div className="border rounded-lg p-4 bg-card-muted">
 ...
 <div className="border rounded-lg p-4 bg-card-muted">
 <h4 className="font-semibold text-foreground mb-2">Security Guarantees</h4>
 <ul className="text-sm text-foreground space-y-1">
 ...
 <h4 className="font-semibold text-foreground mb-2">Why MPC-based CKD is Revolutionary</h4>
 ...
 <div className="bg-card-muted p-4 rounded-lg mb-4">
 <h4 className="font-semibold text-foreground mb-2">DAO Controls Keystore Access to MPC</h4>
 <p className="text-foreground">
 ...
 <h4 className="font-semibold text-foreground mb-2">Cryptographic Properties</h4>
 <p className="text-sm text-foreground mb-2">
 ...
 <div className="bg-card-muted border-l-4 border-border p-4">
 <h4 className="font-semibold text-foreground mb-2">Example: CKD Request</h4>
 <p className="text-sm text-foreground mb-2">
              How a TEE app requests a deterministic secret:
            </p>
 <pre className="bg-card-muted p-2 rounded text-xs overflow-x-auto">
