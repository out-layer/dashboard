...
export default function TeeAttestationSection() {
 ...
 <h2 className="text-3xl font-bold mb-6 text-accent-text">TEE Attestation</h2>
 ...
 <div className="bg-card-muted border-l-4 border-border p-4 my-4">
 ...
 <div className="bg-card-muted border-l-4 border-border p-4 my-4">
 <p className="text-foreground font-semibold mb-2">Register Contract:</p>
 <p className="text-foreground text-sm mb-2">
              Registration is handled by a dedicated smart contract deployed at:
            </p>
 <div className="bg-card rounded p-2 font-mono text-sm">
 <p className="text-foreground"><strong>Testnet:</strong> <code className="text-muted-foreground">worker.outlayer.testnet</code></p>
 <p className="text-foreground"><strong>Mainnet:</strong> <code className="text-muted-foreground">worker.outlayer.near</code></p>
            </div>
 ...
 className="underline hover:text-accent-text font-semibold"
              >
                NEAR Explorer
              </a>
            </p>
 ...
 <div className="bg-card border-2 border-border rounded-lg p-6 my-4">
 <h4 className="text-lg font-semibold text-foreground mb-3">Registration Process:</h4>
 ...
 <span className="inline-flex items-center justify-center w-6 h-6 rounded-full bg-card-muted text-white text-sm font-bold mr-3 flex-shrink-0">1</span>
                <div>
 <p className="font-semibold text-foreground">Worker Generates TDX Quote</p>
 ...
 <span className="inline-flex items-center justify-center w-6 h-6 rounded-full bg-card-muted text-white text-sm font-bold mr-3 flex-shrink-0">2</span>
                <div>
 <p className="font-semibold text-foreground">Submit to Register Contract</p>
 <p className="text-foreground text-sm">
 The worker calls <code className="bg-card-muted px-1 rounded">register_worker</code> on the NEAR register-contract,
 ...
 <span className="inline-flex items-center justify-center w-6 h-6 rounded-full bg-card-muted text-white text-sm font-bold mr-3 flex-shrink-0">4</span>
                <div>
 <p className="font-semibold text-foreground">Extract & Whitelist All 5 Measurements</p>
 <p className="text-foreground text-sm">
 ...
 <li className="flex items-start">
 <span className="inline-flex items-center justify-center w-6 h-6 rounded-full bg-card-muted text-white text-sm font-bold mr-3 flex-shrink-0">5</span>
                <div>
 <p className="font-semibold text-foreground">Register Public Key for Execution</p>
 <p className="text-foreground text-sm">
 During registration, the worker also submits its <strong>public key</strong>. This key is added to
 the main OutLayer contract and is the <strong>only key authorized</strong> to call <code className="bg-card-muted px-1 rounded">resolve_execution</code> to finalize execution results.
                    This prevents unauthorized workers from submitting fake results.
                  </p>
                </div>
              </li>
 <li className="flex items-start">
 <span className="inline-flex items-center justify-center w-6 h-6 rounded-full bg-card-muted text-white text-sm font-bold mr-3 flex-shrink-0">6</span>
                <div>
 ...
 <div className="bg-card-muted border-l-4 border-yellow-500 p-4 my-4">
 <p className="text-foreground font-semibold mb-2">What are the 5 TDX Measurements?</p>
 <p className="text-foreground text-sm">
 ...
 <div className="bg-card-muted border-l-4 border-border p-4 my-4">
 <p className="text-foreground font-semibold mb-2">How the key is bound to the enclave</p>
 <p className="text-foreground text-sm">
              Because an ML-DSA-65 public key (1952 bytes) doesn&apos;t fit in the quote&apos;s <code className="bg-card/60 px-1 rounded">report_data</code> field, its <strong>SHA-256 hash</strong> is embedded there instead (ed25519 keys are embedded raw).
 ...
 Live on mainnet: <code className="bg-card-muted px-1 rounded">worker.outlayer.near</code> signs <code className="bg-card-muted px-1 rounded">resolve_execution</code> with an <code className="bg-card-muted px-1 rounded">ml-dsa-65:</code> key. This hardens the trust
 ...
 <div className="bg-card border-2 border-border rounded-lg p-6 my-4">
 <h4 className="text-lg font-semibold text-foreground mb-3">What Gets Attested:</h4>
 <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
 <div className="bg-card-muted p-3 rounded">
 <p className="font-semibold text-foreground mb-1"> Source Code</p>
 <p className="text-foreground text-sm">
                  GitHub repository URL and exact commit hash that was compiled.
                </p>
              </div>
 <div className="bg-card-muted p-3 rounded">
 <p className="font-semibold text-foreground mb-1"> WASM Hash</p>
 <p className="text-foreground text-sm">
                  SHA256 of the compiled WebAssembly binary that was executed.
                </p>
              </div>
 <div className="bg-card-muted p-3 rounded">
 <p className="font-semibold text-foreground mb-1"> Input Hash</p>
 <p className="text-foreground text-sm">
                  SHA256 of the input data sent to the WASM program.
                </p>
              </div>
 <div className="bg-card-muted p-3 rounded">
 <p className="font-semibold text-foreground mb-1"> Output Hash</p>
 <p className="text-foreground text-sm">
                  SHA256 of the output returned by the WASM execution.
                </p>
              </div>
 <div className="bg-card-muted p-3 rounded">
 <p className="font-semibold text-foreground mb-1"> Worker Measurement</p>
 <p className="text-foreground text-sm">
                  TDX measurement identifying which registered worker performed the execution.
                  Workers are registered with <a href="/docs/trust-verification#measurements" className="underline hover:text-foreground">all 5 TDX measurements</a>.
                </p>
              </div>
 <div className="bg-card-muted p-3 rounded">
 <p className="font-semibold text-foreground mb-1"> TDX Quote</p>
 <p className="text-foreground text-sm">
 ...
 <p className="text-foreground mb-3">
            ...
            genuine Intel TDX environment.</strong> The binary is identified by its <code className="bg-card-muted px-1 rounded">wasm_hash</code> — a SHA256 of the exact bytes that ran.
 ...
 <div className="bg-card-muted border-l-4 border-yellow-500 p-4 my-4">
 <p className="text-foreground font-semibold mb-2">The anchor is the wasm_hash, not a repo + commit</p>
 <p className="text-foreground text-sm">
              A source repo and commit may also be recorded, so you can read the human-readable code — but that
              is a convenience, not the anchor. A repo can be deleted or a commit rewritten; the <code className="bg-card px-1 rounded">wasm_hash</code> cannot. Trust follows the bytes, addressed
              by their hash.
            </p>
          </div>

 <div className="bg-destructive/10 border-l-4 border-red-500 p-4 my-4">
 <p className="text-destructive-text font-semibold mb-2">TEE proves what ran, not that it is honest</p>
 <p className="text-destructive-text text-sm">
 The attestation does <strong>not</strong> claim the program&apos;s logic is correct or honest. It proves <em>what ran</em>, not that <em>what ran is trustworthy</em>. To trust a result, audit the WASM (by its hash).
            </p>
          </div>

 <h4 className="text-lg font-semibold text-foreground mt-6 mb-2">Acting on the output</h4>
 <p className="text-foreground mb-3">
 ...
 <p className="text-foreground font-semibold mb-2">Signing keys — the distinction that matters</p>
 ...
 A key the developer generates and stores as a <strong>regular secret</strong> is held by both the
              ...
              <li>
 A <strong><code className="bg-card-muted px-1 rounded">PROTECTED_</code> secret is generated inside
 ...
 <div className="bg-card-muted border-l-4 border-border p-4 my-4">
 <p className="text-foreground font-semibold mb-2">Is the consumer &quot;privy&quot; to verification?</p>
 <p className="text-foreground text-sm">
 ...
 the age of the source data itself. Enforcing source freshness is the <strong>program&apos;s</strong>            responsibility: only the program knows where &quot;age&quot; lives in a given source&apos;s response, and
            some sources expose no timestamp at all.
          </p>

 <div className="bg-card border-2 border-border rounded-lg p-4 my-4">
 <p className="text-foreground font-semibold mb-2">A program that needs freshness guarantees should:</p>
 <ul className="list-disc list-inside space-y-2 text-foreground text-sm">
              <li>
 ...
 <div className="bg-card border-2 border-border rounded-lg p-6 my-4">
 <h4 className="text-lg font-semibold text-foreground mb-3">How to Verify an Attestation:</h4>

 <div className="space-y-4">
 <div className="border-l-4 border-border pl-4">
 <p className="font-semibold text-foreground mb-1">Step 1: Authenticity — is the quote genuine?</p>
 <p className="text-foreground text-sm mb-2">
 ...
 Collateral is time-bounded, so a quote is verified <em>as of the moment it was produced</em>.
                  Every collateral version we publish on chain is archived and served at <code className="bg-card-muted px-1 rounded">GET /public/collateral?fmspc=…&amp;at=…</code>, so an
 ...
 <div className="border-l-4 border-border pl-4">
 <p className="font-semibold text-foreground mb-1">Step 2: Identity — is it an approved worker build?</p>
 <p className="text-foreground text-sm mb-2">
 Take the measurements decoded from the <em>verified</em> quote and ask the register-contract
 (<code className="bg-card-muted px-1 rounded">worker.outlayer.near</code>) whether they are approved: <code className="bg-card-muted px-1 rounded">is_measurements_approved</code>. A genuine TEE running
                  someone else&apos;s code fails here. All five measurements are checked — <a href="/docs/trust-verification#measurements" className="underline hover:text-accent-text">MRTD + RTMR0-3</a>.
                </p>
              </div>

 <div className="border-l-4 border-border pl-4">
 <p className="font-semibold text-foreground mb-1">Step 3: Binding — does it cover this execution?</p>
 <p className="text-foreground text-sm mb-2">
 The TEE hashes every task parameter into the quote&apos;s REPORTDATA <em>before</em> Intel signs it.
                  ...
                  exact input, output, code, caller and payment — see the <a href="#task-hash" className="underline hover:text-accent-text">Task Hash section</a> below.
                </p>
 ...
 <div className="border-l-4 border-border pl-4">
 <p className="font-semibold text-foreground mb-1">Step 2: Verify Input/Output Hashes</p>
 <p className="text-foreground text-sm mb-2">
                  Fetch the NEAR transaction from the blockchain (using the transaction_hash). Extract the input data
 from the <code className="bg-card-muted px-1 rounded">execution_requested</code> event, and the output
 from the final receipt&apos;s <code className="bg-card-muted px-1 rounded">SuccessValue</code>. Calculate
 ...
 <div className="border-l-4 border-border pl-4">
 <p className="font-semibold text-foreground mb-1">Step 3: Verify Source Code</p>
 <p className="text-foreground text-sm mb-2">
 ...
 <div className="border-l-4 border-border pl-4">
 <p className="font-semibold text-foreground mb-1">Step 4: Verify WASM Hash (Optional)</p>
 <p className="text-foreground text-sm mb-2">
 ...
 <div className="bg-card-muted border-l-4 border-border p-4 my-4">
 <p className="text-foreground font-semibold mb-2">Cryptographic Chain of Trust:</p>
 <p className="text-foreground text-sm">
 ...
 <strong>TEE Worker</strong> (verified by <a href="/docs/trust-verification#measurements" className="underline hover:text-muted-foreground">5 TDX measurements</a>) → producing → <strong>Output Data</strong>. Every link is
 ...
 <div className="bg-card-muted border-l-4 border-border p-4 my-4">
 <p className="text-foreground font-semibold mb-2">The Problem:</p>
 <p className="text-foreground text-sm">
 ...
 <div className="bg-card-muted border-l-4 border-border p-4 my-4">
 <p className="text-foreground font-semibold mb-2">The Solution:</p>
 <p className="text-foreground text-sm mb-2">
 ...
 <div className="bg-card border-2 border-border rounded-lg p-6 my-4">
 <h4 className="text-lg font-semibold text-foreground mb-3">Task Hash Algorithm:</h4>

 <p className="text-foreground text-sm mb-3">
 The Task Hash is calculated using <strong>binary concatenation + SHA256</strong>:
            </p>

 <div className="bg-card-muted p-4 rounded border border-border-strong font-mono text-xs mb-3">
 <p className="text-foreground mb-1">task_hash = SHA256(</p>
 <div className="pl-4 space-y-1">
 <p className="text-foreground">task_type (UTF-8 string) +</p>
 <p className="text-foreground">task_id (i64, little-endian) +</p>
 <p className="text-foreground">repo_url (UTF-8 string, optional) +</p>
 <p className="text-foreground">commit_hash (UTF-8 string, optional) +</p>
 <p className="text-foreground">build_target (UTF-8 string, optional) +</p>
 <p className="text-foreground">wasm_hash (hex string, optional) +</p>
 <p className="text-foreground">input_hash (hex string, optional) +</p>
 <p className="text-foreground">output_hash (hex string, always present) +</p>
 <p className="text-foreground">block_height (u64, little-endian, optional)</p>
              </div>
 <p className="text-foreground">)</p>
            </div>

 <div className="bg-card-muted border border-border rounded p-3 mb-3">
 <p className="text-foreground text-sm font-semibold mb-1">Important Details:</p>
 <ul className="list-disc list-inside space-y-1 text-foreground text-xs">
 ...
 <div className="border-l-4 border-border pl-4">
 <p className="font-semibold text-foreground mb-1">Step 1: Worker Calculates Task Hash</p>
 <p className="text-foreground text-sm">
 ...
 <div className="border-l-4 border-border pl-4">
 <p className="font-semibold text-foreground mb-1">Step 2: Embed in REPORTDATA</p>
 <p className="text-foreground text-sm">
 ...
 <div className="border-l-4 border-border pl-4">
 <p className="font-semibold text-foreground mb-1">Step 3: Intel Signs the Quote</p>
 <p className="text-foreground text-sm">
 ...
 <div className="border-l-4 border-border pl-4">
 <p className="font-semibold text-foreground mb-1">Step 4: Verification</p>
 <p className="text-foreground text-sm">
 ...
 <div className="bg-card-muted border-l-4 border-border p-4 my-4">
 <p className="text-foreground font-semibold mb-2">Interactive Verification in Dashboard:</p>
 <p className="text-foreground text-sm mb-2">
 ...
 <ol className="list-decimal list-inside space-y-1 text-foreground text-sm ml-2">
 ...
 <div className="bg-card border-2 border-border-strong rounded-lg p-4 my-4">
 <h4 className="text-md font-semibold text-foreground mb-2">Example: Preventing Quote Swapping</h4>
 <div className="space-y-2 text-sm">
 <div className="bg-destructive/10 border border-destructive/30 rounded p-2">
 <p className="text-destructive-text font-semibold"> Attack (without Task Hash):</p>
 ...
 <div className="bg-card-muted border border-border rounded p-2">
 <p className="text-foreground font-semibold"> Defense (with Task Hash):</p>
 ...
 <h4 className="font-semibold text-foreground">Hardware Isolation</h4>
              </div>
 <p className="text-foreground text-sm">
 ...
 <div className="flex items-center mb-2">
 <span className="text-2xl mr-2"></span>
 <h4 className="font-semibold text-foreground">Intel Signature</h4>
              </div>
 <p className="text-foreground text-sm">
 ...
 <div className="flex items-center mb-2">
 <span className="text-2xl mr-2"></span>
 <h4 className="font-semibold text-foreground">Tamper-Proof</h4>
              </div>
 <p className="text-foreground text-sm">
 ...
 <div className="flex items-center mb-2">
 <span className="text-2xl mr-2"></span>
 <h4 className="font-semibold text-foreground">Verifiable by Anyone</h4>
              </div>
 <p className="text-foreground text-sm">
 ...
 <div className="flex items-center mb-2">
 <span className="text-2xl mr-2"></span>
 <h4 className="font-semibold text-foreground">Code Transparency</h4>
              </div>
 <p className="text-foreground text-sm">
 ...
 <div className="bg-destructive/10 border-l-4 border-red-500 p-4 my-4">
 <p className="text-destructive-text font-semibold mb-2">What TEE Does NOT Guarantee:</p>
 <ul className="list-disc list-inside space-y-1 text-destructive-text text-sm">
 ...
 <div className="bg-card border-2 border-border rounded-lg p-6 my-4">
 <h4 className="text-lg font-semibold text-foreground mb-3">Using the Dashboard:</h4>

 <ol className="space-y-3">
 <li className="flex items-start">
 <span className="inline-flex items-center justify-center w-6 h-6 rounded-full bg-card-muted text-white text-sm font-bold mr-3 flex-shrink-0">1</span>
                <div>
 <p className="font-semibold text-foreground">Navigate to Executions Page</p>
 <p className="text-foreground text-sm">
 ...
 <span className="inline-flex items-center justify-center w-6 h-6 rounded-full bg-card-muted text-white text-sm font-bold mr-3 flex-shrink-0">2</span>
                <div>
 <p className="font-semibold text-foreground">Click &quot;View Attestation&quot;</p>
 <p className="text-foreground text-sm">
 ...
 <span className="inline-flex items-center justify-center w-6 h-6 rounded-full bg-card-muted text-white text-sm font-bold mr-3 flex-shrink-0">3</span>
                <div>
 <p className="font-semibold text-foreground">View Attestation Details</p>
 <p className="text-foreground text-sm">
 ...
 <span className="inline-flex items-center justify-center w-6 h-6 rounded-full bg-card-muted text-white text-sm font-bold mr-3 flex-shrink-0">4</span>
                <div>
 <p className="font-semibold text-foreground">Verify the Quote</p>
 <p className="text-foreground text-sm">
 ...
 <span className="inline-flex items-center justify-center w-6 h-6 rounded-full bg-card-muted text-white text-sm font-bold mr-3 flex-shrink-0">5</span>
                <div>
 <p className="font-semibold text-foreground">Verify Input/Output Hashes</p>
 <p className="text-foreground text-sm">
 ...
 <span className="inline-flex items-center justify-center w-6 h-6 rounded-full bg-card-muted text-white text-sm font-bold mr-3 flex-shrink-0">6</span>
                <div>
 <p className="font-semibold text-foreground">Audit Source Code</p>
 <p className="text-foreground text-sm">
 ...
 <div className="bg-card-muted border-l-4 border-border p-4 my-4">
 <p className="text-foreground font-semibold mb-2">Interactive Verification:</p>
 <p className="text-foreground text-sm">
