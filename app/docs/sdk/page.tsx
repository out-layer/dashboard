...
cargo build --target wasm32-wasip2 --release`}
 ...
 <td className="px-4 py-3 text-sm font-semibold text-foreground">Yes</td>
              </tr>
 ...
 <td className="px-4 py-3 text-sm font-semibold text-foreground">Yes (or read env vars directly)</td>
              </tr>
              <tr>
...
let api_key = std::env::var("OPENAI_API_KEY").ok();`}
 ...
 <strong>Injected environment variables:</strong> <code>NEAR_SENDER_ID</code>, <code>NEAR_PREDECESSOR_ID</code>, <code>NEAR_TRANSACTION_HASH</code>, <code>OUTLAYER_REQUEST_ID</code>, <code>OUTLAYER_PROJECT_UUID</code>, <code>OUTLAYER_PROJECT_OWNER</code>, <code>OUTLAYER_PROJECT_NAME</code>, <code>USD_PAYMENT</code>,            plus any custom secrets stored via the dashboard.
          </p>
        </div>
      </section>
...
# Output: target/wasm32-wasip2/release/my-outlayer-app.wasm`}
 ...
 <h4 className="font-semibold text-foreground mb-2">User Storage</h4>
 ...
 <div className="border border-border rounded-lg p-4 bg-card-muted">
 <h4 className="font-semibold text-foreground mb-2">Worker Storage</h4>
 <p className="text-sm text-foreground mb-2">
 ...
 <div className="border border-border rounded-lg p-4 bg-card-muted">
 <h4 className="font-semibold text-foreground mb-2">Public Storage</h4>
 <p className="text-sm text-foreground mb-2">
