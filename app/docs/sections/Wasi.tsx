...
export default function WasiSection() {
 ...
 <h4 className="font-semibold text-foreground mb-2">What are Host Functions?</h4>
 ...
 <li>Distributes NEAR tokens across accounts using <code className="bg-card-muted px-1 rounded">transfer()</code></li>
 <li>Executes batch contract calls (e.g., token purchases, staking delegation)</li>
 <li>Queries account balances via <code className="bg-card-muted px-1 rounded">view()</code></li>
            </ul>
          </div>
...
world rpc-host {
 ...
 <li><strong>WASI Preview 2:</strong> Host functions require <code className="bg-card-muted px-1 rounded">wasm32-wasip2</code> target</li>
 <li><strong>Signer credentials:</strong> Must provide <code className="bg-card-muted px-1 rounded">NEAR_SENDER_PRIVATE_KEY</code> via secrets</li>
 <li><strong>NEAR tokens:</strong> Signer account must have sufficient balance for gas and deposits</li>
            </ul>
          </div>

 <div className="bg-card-muted border-l-4 border-border p-4 mt-4">
 <h4 className="font-semibold text-foreground mb-2">API Versioning</h4>
 <p className="text-sm text-foreground mb-2">
 Host functions are versioned using semantic versioning (<code className="bg-card-muted px-1 rounded">@0.1.0</code>). This ensures backward compatibility when the API evolves.
            </p>
 <ul className="list-disc list-inside text-sm text-foreground space-y-1">
 <li><strong>Current version:</strong> <code className="bg-card-muted px-1 rounded">near:rpc@0.1.0</code></li>
 ...
 <span className="ml-2 text-xs bg-card-muted text-foreground px-2 py-1 rounded">P1</span>
              </h4>
 ...
 <span className="ml-2 text-xs bg-card-muted text-foreground px-2 py-1 rounded">P2</span>
              </h4>
 ...
 <span className="ml-2 text-xs bg-card-muted text-foreground px-2 py-1 rounded">P2</span>
 <span className="ml-2 text-xs bg-card-muted text-foreground px-2 py-1 rounded">Host Functions</span>
              </h4>
 ...
 <span className="ml-2 text-xs bg-card-muted text-foreground px-2 py-1 rounded">P2</span>
 <span className="ml-2 text-xs bg-card-muted text-foreground px-2 py-1 rounded">Full Stack</span>
              </h4>
 <p className="text-sm text-muted-foreground">Token launchpad with CAPTCHA verification</p>
            </div>
          </div>

 <div className="p-5 bg-gradient-to-r from-blue-50 to-card-muted border border-border rounded-lg">
...
# 5. Output compiled WASM with SHA256 checksum`}
 ...
 <div className="bg-card-muted border-l-4 border-border p-3 mb-4">
 <p className="text-sm text-foreground mb-2">
 <strong>Troubleshooting:</strong> If you get <code className="bg-card-muted px-1 rounded">cabi_realloc</code> error with wasm32-wasip2,
 ...
 Solution: Use <code className="bg-card-muted px-1 rounded">wasm32-wasip1</code> instead.
            </p>
 <p className="text-sm text-foreground">
