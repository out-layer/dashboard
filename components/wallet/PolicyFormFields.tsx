...
export function PolicyFormFields({ policyForm, onChange, apiKeyHash, knownKeyHashes, onSaveKey }: PolicyFormFieldsProps) {
 ...
 <p className="text-xs text-faint-foreground mb-2">Native NEAR only (not wNEAR or NEP-141 tokens). Leave empty for no limit. For token-specific limits, use the JSON editor.</p>
 ...
 <h3 className="text-sm font-semibold text-foreground mb-2">Address Restrictions</h3>
 <p className="text-xs text-faint-foreground mb-2">Restrict which destination accounts the wallet can interact with (withdraw, transfer, contract call).</p>
 ...
 <div className="grid grid-cols-2 gap-4">
        <div>
 <label className="block text-sm font-medium text-foreground mb-1">Allowed Tokens</label>
          <input
            type="text"
 ...
 className="w-full border border-border-strong rounded px-3 py-2 text-sm"
        ...
        <div>
 <label className="block text-sm font-medium text-foreground mb-1">Allowed Transaction Types</label>
          {(() => {
 ...
 <div className="border border-border bg-card-muted rounded-lg p-4">
 <h3 className="text-sm font-semibold text-foreground mb-1">Capabilities (advanced)</h3>
 ...
 className="w-full border border-border-strong rounded px-3 py-2 text-sm"
          />
 <p className="text-xs text-destructive-text mt-0.5">
 ...
 className="rounded border-border-strong"
      ...
      {/* Time Restrictions */}
      <div>
 <h3 className="text-sm font-semibold text-foreground mb-2">Time Restrictions (UTC)</h3>
 ...
 className="w-full border border-border-strong rounded px-3 py-2 text-sm"
            />
 <p className="text-xs text-faint-foreground mt-1">1=Mon ... 7=Sun</p>
          </div>
        </div>
      </div>
 ...
 <div className="grid grid-cols-2 gap-4">
        <div>
 <label className="block text-sm font-medium text-foreground mb-1">Max Transactions per Hour</label>
          <input
            type="number"
 ...
 className="w-full border border-border-strong rounded px-3 py-2 text-sm"
          />
 <p className="text-xs text-faint-foreground mt-1">Counts all operation types including intents deposit and swap.</p>
        </div>
        <div>
 <label className="block text-sm font-medium text-foreground mb-1">
            Webhook URL
            <button
              type="button"
 className="ml-1.5 inline-flex items-center justify-center w-4 h-4 rounded-full bg-card-muted text-muted-foreground text-[10px] font-bold hover:bg-card-muted align-middle"
