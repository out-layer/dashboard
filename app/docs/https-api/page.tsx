...
export default function HttpsApiPage() {
 ...
 <h4 className="font-semibold text-foreground mb-2">NEAR Transactions</h4>
 ...
 <div className="border border-border rounded-lg p-4 bg-card-muted">
 <h4 className="font-semibold text-foreground mb-2">HTTPS API</h4>
 <ul className="text-sm text-foreground space-y-1">
...
curl -X POST https://api.outlayer.ai/call/alice.near/my-assistant \\
 ...
 <td className="px-4 py-3 text-sm text-foreground font-semibold">Yes</td>
...
let db_url = std::env::var("DATABASE_URL")
 ...
 <div className="bg-card-muted border-l-4 border-border p-4 mb-6">
 <p className="text-sm text-foreground">
 <strong>Works the same as NEAR transactions.</strong> The <code>secrets_ref</code> field uses the same keystore system as the <code>secrets_ref</code> parameter in <code>request_execution</code> contract calls.
