...
# {"price":"3500.00"}`}
 ...
 <div className="border border-border rounded-lg p-4 bg-card-muted">
 <h4 className="font-semibold text-foreground mb-2">Oracle Price Feeds</h4>
 <p className="text-sm text-muted-foreground">Share price data across projects without API calls</p>
          </div>
 <div className="border border-border rounded-lg p-4 bg-card-muted">
 <h4 className="font-semibold text-foreground mb-2">Public Configuration</h4>
 ...
 <div className="border border-border rounded-lg p-4 bg-card-muted">
 <h4 className="font-semibold text-foreground mb-2">Private Tokens</h4>
 ...
 <div className="border border-border rounded-lg p-4 bg-card-muted">
 <h4 className="font-semibold text-foreground mb-2">Distributed Locks</h4>
