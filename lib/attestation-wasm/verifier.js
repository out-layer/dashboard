...
export function js_verify_with_root_ca(raw_quote, quote_collateral, root_ca_der, now) {
    const ret = wasm.js_verify_with_root_ca(raw_quote, quote_collateral, root_ca_der, now);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * established fact.
 * @param {Uint8Array} quote
 * @returns {any}
 */
export function parse_quote(quote) {
    const ptr0 = passArray8ToWasm0(quote, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.parse_quote(ptr0, len0);
    return ret;
}
 ...
 * @returns {any}
 */
export function verify_quote(quote, collateral_json, now_secs) {
    const ptr0 = passArray8ToWasm0(quote, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(collateral_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.verify_quote(ptr0, len0, ptr1, len1, now_secs);
    return ret;
}
