    ...
    <div className="prose max-w-none">
      ...
      <div className="space-y-6">
        ...
        <section id="wasi-preview">
          ...
          <div className="bg-card-muted p-4 rounded-lg space-y-3">
            <div>
              <strong className="text-foreground">WASI Preview 1 (P1)</strong>
              <ul className="list-disc list-inside text-foreground ml-4 mt-1">
                <li>Target: <code className="bg-card-muted px-2 py-1 rounded">wasm32-wasip1</code></li>
            ...
            <div>
              <strong className="text-foreground">WASI Preview 2 (P2)</strong>
              <ul className="list-disc list-inside text-foreground ml-4 mt-1">
        ...
        <section id="host-functions">
          ...
          <div className="bg-info/10 border-l-4 border-info/50 p-4 mb-4">
            <h4 className="font-semibold text-info mb-2">What are Host Functions?</h4>
          ...
          <h4 className="font-semibold text-foreground mb-2">Available Functions</h4>
          <div className="space-y-3 mb-4">
            <div className="border-l-4 border-orange-400 pl-3">
              ...
              <p className="text-xs text-muted-foreground font-mono bg-card-muted p-2 rounded">
            ...
            <div className="border-l-4 border-border-strong pl-3">
              <p className="font-mono text-sm text-foreground mb-1">
          ...
          <h4 className="font-semibold text-foreground mb-2">Key Security Features</h4>
          <ul className="list-disc list-inside text-foreground space-y-1 mb-4 text-sm">
            <li><strong>WASM provides signer:</strong> Your code passes <code className="bg-card-muted px-1 rounded">signer_key</code> from secrets - worker never uses its own keys</li>
          ...
          <div className="bg-success/10 border-l-4 border-success/50 p-4 mb-4">
            <h4 className="font-semibold text-success-text mb-2">Example: botfather-example</h4>
            ...
            <ul className="list-disc list-inside text-sm text-success-text ml-4 space-y-1">
              <li>Creates multiple NEAR accounts programmatically using <code className="bg-success/15 px-1 rounded">call()</code></li>
              <li>Distributes NEAR tokens across accounts using <code className="bg-success/15 px-1 rounded">transfer()</code></li>
              <li>Executes batch contract calls (e.g., token purchases, staking delegation)</li>
              <li>Queries account balances via <code className="bg-success/15 px-1 rounded">view()</code></li>
            </ul>
          </div>

          <h4 className="font-semibold text-foreground mb-2">WIT Interface Definition</h4>
          <p className="text-sm text-foreground mb-2">
            Host functions are defined in <code className="bg-card-muted px-1 rounded">worker/wit/world.wit</code>:
          </p>
    ...
    import api;
          ...
          <div className="bg-warning/10 border-l-4 border-warning/50 p-4">
            ...
            <ul className="list-disc list-inside text-sm text-warning space-y-1">
              <li><strong>WASI Preview 2:</strong> Host functions require <code className="bg-warning/15 px-1 rounded">wasm32-wasip2</code> target</li>
              <li><strong>Signer credentials:</strong> Must provide <code className="bg-warning/15 px-1 rounded">NEAR_SENDER_PRIVATE_KEY</code> via secrets</li>
              <li><strong>NEAR tokens:</strong> Signer account must have sufficient balance for gas and deposits</li>
            </ul>
          </div>

          <div className="bg-info/10 border-l-4 border-info/50 p-4 mt-4">
            <h4 className="font-semibold text-info mb-2">API Versioning</h4>
            <p className="text-sm text-info mb-2">
              Host functions are versioned using semantic versioning (<code className="bg-info/15 px-1 rounded">@0.1.0</code>). This ensures backward compatibility when the API evolves.
            </p>
            <ul className="list-disc list-inside text-sm text-info space-y-1">
              <li><strong>Current version:</strong> <code className="bg-info/15 px-1 rounded">near:rpc@0.1.0</code></li>
        ...
        <section id="critical-requirements">
          ...
          <div className="bg-warning/10 border-l-4 border-warning/50 p-4">
            <ul className="list-disc list-inside space-y-2 text-foreground">
              <li><strong>Binary format:</strong> Must use <code className="bg-card-muted px-2 py-1 rounded">[[bin]]</code> in Cargo.toml, NOT <code className="bg-card-muted px-2 py-1 rounded">[lib]</code></li>
              <li><strong>Entry point:</strong> Must have <code className="bg-card-muted px-2 py-1 rounded">fn main()</code> function</li>
              ...
              <li><strong>Flush:</strong> Call <code className="bg-card-muted px-2 py-1 rounded">stdout().flush()</code> after writing</li>
            </ul>
          </div>
        </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            <div className="border border-border rounded-lg p-4 hover:shadow-md transition-shadow">
              <h4 className="font-semibold mb-1">
                ...
                <span className="ml-2 text-xs bg-info/10 text-info px-2 py-1 rounded">P1</span>
              </h4>
              <p className="text-sm text-muted-foreground">Random number generation (starter example)</p>
            </div>
            ...
            <div className="border border-border rounded-lg p-4 hover:shadow-md transition-shadow">
              ...
              <p className="text-sm text-muted-foreground">NEAR context & environment variables</p>
            </div>
            ...
            <div className="border border-border rounded-lg p-4 hover:shadow-md transition-shadow">
              ...
              <p className="text-sm text-muted-foreground">OpenAI API integration (HTTPS requests)</p>
            </div>
            ...
            <div className="border border-border rounded-lg p-4 hover:shadow-md transition-shadow">
              ...
              <p className="text-sm text-muted-foreground">OpenWeather API oracle (specialized price oracle)</p>
            </div>
            ...
            <div className="border border-border rounded-lg p-4 hover:shadow-md transition-shadow">
              ...
              <p className="text-sm text-muted-foreground">Multi-source price oracle with aggregation</p>
            </div>
            ...
            <div className="border border-border rounded-lg p-4 hover:shadow-md transition-shadow">
              ...
              <p className="text-sm text-muted-foreground">Ethereum blockchain data access via RPC</p>
            </div>
            ...
            <div className="border border-border rounded-lg p-4 hover:shadow-md transition-shadow">
              ...
              <p className="text-sm text-muted-foreground">Account factory with AI names & batch operations. Demonstrates <code className="bg-card-muted px-1 rounded text-xs">call()</code> and <code className="bg-card-muted px-1 rounded text-xs">transfer()</code> host functions for NEAR RPC access.</p>
            </div>
            ...
            <div className="border border-border rounded-lg p-4 hover:shadow-md transition-shadow">
              ...
              <p className="text-sm text-muted-foreground">DEX swaps via NEAR Intents (paused FT transfer)</p>
            </div>
            ...
            <div className="border border-border rounded-lg p-4 hover:shadow-md transition-shadow">
              <h4 className="font-semibold mb-1">
                ...
                <span className="ml-2 text-xs bg-info/10 text-info px-2 py-1 rounded">P1</span>
                <span className="ml-2 text-xs bg-destructive/10 text-destructive-text px-2 py-1 rounded">Advanced</span>
              </h4>
              <p className="text-sm text-muted-foreground">Anonymous DAO voting with cryptographic privacy (ECIES, HKDF, Merkle trees)</p>
            </div>
            ...
            <div className="border border-border rounded-lg p-4 hover:shadow-md transition-shadow">
              <h4 className="font-semibold mb-1">
                ...
                <span className="ml-2 text-xs bg-purple-100 text-purple-800 px-2 py-1 rounded">P2</span>
                <span className="ml-2 text-xs bg-success/10 text-success-text px-2 py-1 rounded">Full Stack</span>
              </h4>
              <p className="text-sm text-muted-foreground">Token launchpad with CAPTCHA verification</p>
            </div>
          </div>

          <div className="p-5 bg-gradient-to-r from-blue-50 to-indigo-50 border border-info/30 rounded-lg">
        ...
        <section id="testing-locally">
          ...
          <p className="text-foreground mb-3">
            ...
            This script uses the same Docker image (<code className="bg-card-muted px-1 rounded">outlayer/wasmedge-compiler:rust1.85-wasi25</code>, pinned by digest) and compilation logic as the production worker.
          </p>

          <div className="bg-success/10 border-l-4 border-success/50 p-4 mb-3">
            <p className="text-sm text-success-text mb-2">
...
./scripts/test_compiler.sh \\
  https://github.com/out-layer/random-example main wasm32-wasip1

# Test compilation for WASI Preview 2
./scripts/test_compiler.sh \\
  https://github.com/out-layer/ai-example main wasm32-wasip2
...
# 5. Output compiled WASM with SHA256 checksum`}
          ...
          <ul className="list-disc list-inside text-foreground ml-4 space-y-1 mb-3">
            <li>Uses official Docker image from Docker Hub (no local builds needed)</li>
            <li>Exactly mirrors worker compiler behavior</li>
            <li>Supports all three targets: <code className="bg-card-muted px-1 rounded">wasm32-wasip1</code>, <code className="bg-card-muted px-1 rounded">wasm32-wasip2</code>, <code className="bg-card-muted px-1 rounded">wasm32-wasi</code></li>
            <li>Shows compilation time, file size, and SHA256 checksum</li>
            <li>Configurable memory/CPU limits via environment variables</li>
          </ul>

          <div className="bg-warning/10 border-l-4 border-warning/50 p-3 mb-4">
            <p className="text-sm text-warning mb-2">
              <strong>Troubleshooting:</strong> If you get <code className="bg-warning/15 px-1 rounded">cabi_realloc</code> error with wasm32-wasip2,
              ...
              Solution: Use <code className="bg-warning/15 px-1 rounded">wasm32-wasip1</code> instead.
            </p>
          ...
          <div className="bg-info/10 border-l-4 border-info/50 p-4 mb-3">
            <p className="text-sm text-info mb-2">
              <strong>GitHub Repository:</strong> <a href="https://github.com/fastnear/near-outlayer/tree/main/wasi-examples/wasi-test-runner" target="_blank" rel="noopener noreferrer" className="underline hover:text-info">wasi-examples/wasi-test-runner</a>
            </p>
          </div>
...
# ✅ All checks passed!`}
          ...
          <p className="text-foreground mb-2">
            Test directly using <code className="bg-card-muted px-2 py-1 rounded">wasmtime</code>:
          </p>
...
echo '{"message":"test"}' | wasmtime --env SECRET=my-key your-app.wasm`}
        ...
        <section id="common-pitfalls">
          ...
          <div className="space-y-3">
            <div className="bg-destructive/10 border-l-4 border-destructive/50 p-3">
              <strong className="text-destructive-text">Error: &quot;entry symbol not defined: _initialize&quot;</strong>
              <p className="text-foreground mt-1">Using <code>[lib]</code> instead of <code>[[bin]]</code> in Cargo.toml</p>
            </div>
            <div className="bg-destructive/10 border-l-4 border-destructive/50 p-3">
              <strong className="text-destructive-text">Empty output</strong>
              <p className="text-foreground mt-1">Forgot to call <code>io::stdout().flush()?</code> after writing</p>
            </div>
            <div className="bg-destructive/10 border-l-4 border-destructive/50 p-3">
              <strong className="text-destructive-text">HTTP requests fail</strong>
              <p className="text-foreground mt-1">Using WASI P1 instead of P2 - HTTP requires <code>wasm32-wasip2</code> target</p>
            </div>
            <div className="bg-destructive/10 border-l-4 border-destructive/50 p-3">
              <strong className="text-destructive-text">Output truncated in explorer</strong>
              <p className="text-foreground mt-1">Output exceeds 900 bytes - truncate before returning</p>
            </div>
          </div>
        </section>
        ...
        <section id="next-steps">
          ...
          <ul className="list-disc list-inside space-y-2 text-foreground">
            ...
            <li>Study <strong>private-dao-example</strong> for advanced cryptography (ECIES, HKDF, Merkle trees) and privacy patterns</li>
            <li>Deploy <strong>captcha-example</strong> for full-stack async human verification</li>
          </ul>
        </section>
      </div>
    </div>
