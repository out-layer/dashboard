  ...
  return (
    <div className="max-w-5xl">
          ...
          <div className="min-w-[600px]">
            ...
            <div className="grid grid-cols-[1fr_1fr_1fr] gap-4 items-start">
              <div className="bg-card rounded-lg border-2 border-info/50 p-3 text-center">
                ...
                <div className="text-xs font-bold text-info">Agent A (Sender)</div>
              ...
              <div className="bg-card rounded-lg border-2 border-success/50 p-3 text-center">
                <div className="text-lg mb-1">&#129302;</div>
                <div className="text-xs font-bold text-success-text">Agent B (Receiver)</div>
                <div className="text-xs text-muted-foreground mt-1">Has wallet API key</div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-[1fr_1fr_1fr] gap-4 py-2">
              ...
              <div className="flex flex-col items-center">
                ...
                <span className="text-[10px] text-success-text font-medium">claim check</span>
              </div>
            </div>
      ...
      <section id="mechanism" className="mb-10 scroll-mt-4">
          ...
          <table className="min-w-full text-sm border border-border">
            ...
            <tbody>
              <tr className="border-b">
                ...
                <td className="px-4 py-2 text-success-text font-medium">None</td>
              </tr>
              <tr className="border-b">
        ...
        <div className="bg-info/10 border-l-4 border-info/60 p-4 mb-4">
...
Statuses:
  ...
  reclaimed           - all funds reclaimed by sender`}
        ...
        <div className="bg-warning/10 border-l-4 border-yellow-500 p-4 mb-4">
          <p className="text-sm text-foreground">
          ...
          <table className="min-w-full text-sm border border-border">
            ...
            <tbody>
              <tr className="border-b">
                ...
                <td className="px-4 py-2 text-success-text">None</td>
              ...
              <tr className="border-b">
                ...
                <td className="px-4 py-2 text-success-text">Only a wallet API key</td>
              ...
              <tr className="border-b">
                ...
                <td className="px-4 py-2 text-success-text">Built-in</td>
                <td className="px-4 py-2 text-destructive-text">N/A</td>
                <td className="px-4 py-2 text-warning">Custom logic</td>
              </tr>
              <tr className="border-b">
                <td className="px-4 py-2 font-medium">Reclaim</td>
                <td className="px-4 py-2 text-success-text">Built-in, gasless</td>
                <td className="px-4 py-2 text-destructive-text">N/A (irreversible)</td>
                <td className="px-4 py-2 text-warning">Custom logic + gas</td>
              </tr>
              <tr className="border-b">
                <td className="px-4 py-2 font-medium">On-chain footprint</td>
                <td className="px-4 py-2 text-success-text">Solver relay only</td>
                <td className="px-4 py-2 text-warning">1 transaction</td>
              ...
              <tr className="border-b">
                ...
                <td className="px-4 py-2 text-success-text">One API call</td>
                <td className="px-4 py-2 text-success-text">One API call</td>
