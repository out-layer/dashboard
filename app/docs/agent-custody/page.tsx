...
export default function AgentCustodyPage() {
 ...
 <h3 className="font-semibold text-foreground mb-1">No Private Key Exposure</h3>
 <p className="text-sm text-muted-foreground">The agent never sees or stores a private key. It authenticates with an API key. All transaction signing happens inside a TEE (Trusted Execution Environment) &mdash; even if the agent is fully compromised, the key stays safe.</p>
          </div>
 <div className="border border-border rounded-lg p-5">
 <div className="text-2xl mb-2">&#127760;</div>
 <h3 className="font-semibold text-foreground mb-1">Cross-Chain Value</h3>
 <p className="text-sm text-muted-foreground">One NEAR-native wallet that deposits from and withdraws to NEAR, Ethereum, Bitcoin, Solana, and other chains via the <strong>NEAR Intents</strong> protocol. No bridges, no wrapping. EVM signing (EIP-712 / EIP-191 / raw tx) and Solana signing (messages / transaction messages, ed25519) are supported — you broadcast, the TEE only signs.</p>
          </div>
 <div className="border border-border rounded-lg p-5">
 <div className="text-2xl mb-2">&#128220;</div>
 <h3 className="font-semibold text-foreground mb-1">Policy Engine</h3>
 <p className="text-sm text-muted-foreground">Per-transaction limits, daily/hourly/monthly caps, address whitelists, time restrictions, rate limits, and multisig approval. All policy checks happen inside the TEE &mdash; the agent cannot bypass or tamper with them.</p>
          </div>
 <div className="border border-border rounded-lg p-5">
 <div className="text-2xl mb-2">&#9981;&#65039;</div>
 <h3 className="font-semibold text-foreground mb-1">Gasless Transactions</h3>
 <p className="text-sm text-muted-foreground">Swaps and cross-chain transfers work without the agent holding gas tokens on the destination chain. The NEAR Intents protocol handles gas abstraction.</p>
          </div>
        </div>
 ...
 <strong>Optional: sovereign vaults.</strong> Custody wallets are derived from a shared OutLayer master by default
            ...
            you can deploy a per-customer <Link href="/docs/vaults" className="text-accent-text hover:underline">
              sovereign vault
            </Link>
 ...
 <div className="grid grid-cols-[1fr_2fr_1fr] gap-0 items-start">
              {/* Agent */}
 <div className="bg-card rounded-lg border-2 border-border p-3 text-center">
 <div className="text-lg mb-1">&#129302;</div>
 <div className="text-xs font-bold text-foreground">AI Agent</div>
 <div className="text-xs text-muted-foreground mt-1">Has API key only</div>
              </div>
 ...
 <div className="bg-card rounded-lg border-2 border-border p-3 text-center">
 <div className="text-lg mb-1">&#128100;</div>
 <div className="text-xs font-bold text-muted-foreground">Wallet Owner</div>
 <div className="text-xs text-muted-foreground mt-1">Controls policy</div>
              </div>
            </div>
 ...
 <span className="text-[10px] text-accent-text font-medium">transfer, swap, call</span>
              </div>
              <div />
 <div className="flex flex-col items-center py-1">
 <svg width="24" height="32" className="text-muted-foreground"><path d="M12 0 L12 24 M6 18 L12 24 L18 18" stroke="currentColor" strokeWidth="2" fill="none"/></svg>
 <span className="text-[10px] text-muted-foreground font-medium">set policy, freeze</span>
              </div>
            </div>

            {/* Row 3: TEE box in the center spanning full width */}
 <div className="relative border-2 border-border rounded-lg p-4 bg-card-muted/50">
 <span className="absolute -top-3 left-1/2 -translate-x-1/2 bg-card-muted0 text-white text-xs font-bold px-3 py-0.5 rounded-full whitespace-nowrap">TEE (Intel TDX) &mdash; all security here</span>
 <div className="grid grid-cols-3 gap-4 mt-2">
 <div className="bg-card rounded-lg border border-border p-3 text-center">
 <div className="text-lg mb-1">&#128273;</div>
 <div className="text-xs font-semibold text-foreground">Key Derivation</div>
 <div className="text-xs text-muted-foreground mt-1">MPC master secret + HMAC</div>
 <div className="text-xs text-muted-foreground">Private keys never leave</div>
                </div>
 <div className="bg-card rounded-lg border border-border p-3 text-center">
 <div className="text-lg mb-1">&#9997;&#65039;</div>
 <div className="text-xs font-semibold text-foreground">Transaction Signing</div>
 <div className="text-xs text-muted-foreground mt-1">Signs transfer, intents_withdraw, intents_swap, call, delete</div>
 <div className="text-xs text-muted-foreground">inside secure enclave</div>
                </div>
 <div className="bg-card rounded-lg border border-border p-3 text-center">
 <div className="text-lg mb-1">&#128737;</div>
 <div className="text-xs font-semibold text-foreground">Policy Evaluation</div>
 <div className="text-xs text-muted-foreground mt-1">Decrypts policy from chain</div>
 <div className="text-xs text-muted-foreground">Enforces all limits &amp; rules</div>
                </div>
              </div>
            </div>
 ...
 <svg width="24" height="32" className="text-muted-foreground"><path d="M12 0 L12 24 M6 18 L12 24 L18 18" stroke="currentColor" strokeWidth="2" fill="none"/></svg>
 <span className="text-[10px] text-muted-foreground font-medium leading-tight">submit signed tx<br/>read encrypted policy</span>
 <svg width="24" height="32" className="text-muted-foreground"><path d="M12 24 L12 0 M6 6 L12 0 L18 6" stroke="currentColor" strokeWidth="2" fill="none"/></svg>
                </div>
              </div>
            </div>
 ...
 <div className="bg-card rounded-lg border-2 border-border p-3 text-center">
 <div className="text-lg mb-1">&#9939;&#65039;</div>
 <div className="text-xs font-bold text-muted-foreground">NEAR Blockchain</div>
 <div className="text-xs text-muted-foreground mt-1">Encrypted policy storage</div>
 <div className="text-xs text-muted-foreground">Freeze / unfreeze on-chain</div>
              </div>
 <div className="bg-card rounded-lg border-2 border-border p-3 text-center">
 <div className="text-lg mb-1">&#128256;</div>
 <div className="text-xs font-bold text-muted-foreground">NEAR Intents</div>
 <div className="text-xs text-muted-foreground mt-1">Gasless cross-chain transfers</div>
 <div className="text-xs text-muted-foreground">NEAR, ETH, BTC, SOL</div>
              </div>
            </div>
 ...
 <ol className="list-decimal list-inside text-foreground space-y-2 mt-4">
 ...
 <td className="px-4 py-2">Cross-chain value, held on <code className="bg-card-muted px-1 rounded">intents.near</code></td>
 ...
 The agent uses the <code className="bg-card-muted px-1 rounded">API Key</code> to authenticate all requests.
 ...
 on <code className="bg-card-muted px-1 rounded">intents.near</code>. You move value across chains the way you would with a
 ...
 <p className="text-foreground mb-4">
 The wallet signs EVM payloads directly. <code className="bg-card-muted px-1 rounded">GET /wallet/v1/address</code> returns the NEAR address
 and a single shared secp256k1 <code className="bg-card-muted px-1 rounded">0x</code> address (the same across all EVM chains), and the wallet signs
 EIP-712 typed data, EIP-191 messages, and raw EVM transactions via <code className="bg-card-muted px-1 rounded">/wallet/v1/evm/*</code> &mdash; you build
 and broadcast the transaction; the TEE only keccak-hashes and signs. Solana works the same way via <code className="bg-card-muted px-1 rounded">/wallet/v1/solana/*</code>:
          the wallet has its own base58 ed25519 address and signs off-chain messages and serialized transaction messages (base58 signature); you assemble and
 ...
 <td className="px-4 py-2 text-foreground">&#10003; direct to Intents balance</td>
 <td className="px-4 py-2 text-foreground">&#10003; via Intents (gasless)</td>
 <td className="px-4 py-2 text-foreground">&#10003; NEAR address + direct contract calls</td>
              </tr>
 <tr className="border-b">
 <td className="px-4 py-2 font-semibold">Ethereum</td>
 <td className="px-4 py-2 text-foreground">&#10003; cross-chain (1Click)</td>
 <td className="px-4 py-2 text-foreground">&#10003; via Intents (gasless)</td>
 <td className="px-4 py-2 text-foreground">&#10003; shared 0x address + signing via /wallet/v1/evm/* (client broadcasts)</td>
              </tr>
 <tr className="border-b">
 <td className="px-4 py-2 font-semibold">Bitcoin</td>
 <td className="px-4 py-2 text-foreground">&#10003; cross-chain (1Click)</td>
 <td className="px-4 py-2 text-foreground">&#10003; via Intents (gasless)</td>
 <td className="px-4 py-2 text-faint-foreground">&mdash; (planned)</td>
              </tr>
 <tr className="border-b">
 <td className="px-4 py-2 font-semibold">Solana</td>
 <td className="px-4 py-2 text-foreground">&#10003; cross-chain (1Click)</td>
 <td className="px-4 py-2 text-foreground">&#10003; via Intents (gasless)</td>
 <td className="px-4 py-2 text-foreground">&#10003; base58 address + signing via /wallet/v1/solana/* (client broadcasts)</td>
              </tr>
              <tr>
 <td className="px-4 py-2 font-semibold">Base, Arbitrum, BSC, Polygon, Optimism, Avalanche</td>
 <td className="px-4 py-2 text-foreground">&#10003; cross-chain (1Click)</td>
 <td className="px-4 py-2 text-foreground">&#10003; via Intents (gasless)</td>
 <td className="px-4 py-2 text-foreground">&#10003; same shared 0x address + /wallet/v1/evm/* signing</td>
              </tr>
            </tbody>
          </table>
        </div>
 ...
 <p className="text-sm text-foreground">
 <strong>Gasless cross-chain:</strong> When the agent calls <code className="bg-card-muted px-1 rounded">POST /wallet/v1/intents/withdraw</code> to send tokens to Ethereum or Solana,
            it does not need ETH or SOL for gas. The NEAR Intents protocol handles execution and fee settlement natively.
          </p>
        </div>

 <div className="bg-destructive/10 border-l-4 border-red-500 p-4 mb-4">
 <p className="text-sm text-foreground font-semibold mb-1"> Only send whitelisted Intents assets &mdash; anything else is lost permanently</p>
 <p className="text-sm text-foreground">
 Deposits only work for assets in the NEAR Intents / 1Click token catalog (<code className="bg-destructive/15 px-1 rounded">GET /wallet/v1/tokens</code>),
 ...
 <code className="bg-destructive/15 px-1 rounded">/wallet/v1/intents/deposit/cross-chain</code> (legacy alias <code className="bg-destructive/15 px-1 rounded">/wallet/v1/deposit-intent</code>) are per-request and expire (30 min) &mdash; never reuse an old one or send after expiry.
          </p>
        </div>
      </section>
...
{`{
 ...
 Claimable links (<code className="bg-card-muted px-1 rounded">payment_check</code>) are the exception &mdash;
...
Approver 2: Signs approval via NEAR wallet (dashboard)
 ...
 <td className="px-4 py-2 text-foreground">&#10003; (quorum)</td>
 <td className="px-4 py-2 text-foreground">&#10003;</td>
              </tr>
              <tr>
 <td className="px-4 py-2 font-semibold">Signer</td>
 <td className="px-4 py-2 text-foreground">&#10003;</td>
 <td className="px-4 py-2 text-destructive-text">&#10007;</td>
 <td className="px-4 py-2 text-destructive-text">&#10007;</td>
              </tr>
            </tbody>
          </table>
...
# (e.g. \`eth-…\` → Ethereum).
#  Only send the exact whitelisted token on the exact chain below —
...
{`curl -s -X POST -H "Content-Type: application/json" \\
 ...
 <code className="bg-card-muted px-1 rounded">error: onchain_tx_failed</code>, the decoded
 execution error, and the real <code className="bg-card-muted px-1 rounded">tx_hash</code> &mdash;
 ...
 <code className="bg-card-muted px-1 rounded">/delete</code>,
 <code className="bg-card-muted px-1 rounded">/storage-deposit</code> and
 <code className="bg-card-muted px-1 rounded">/intents/deposit</code>.
 ...
 <code className="bg-card-muted px-1 rounded">status: "failed"</code> via
 <code className="bg-card-muted px-1 rounded">GET /wallet/v1/requests/&#123;id&#125;</code> and the
 <code className="bg-card-muted px-1 rounded">request_completed</code> webhook, not as a
          synchronous 422.
        </p>
...
curl -s -X POST -H "Content-Type: application/json" \\
 ...
 <strong>Status values (exact).</strong> The withdraw/swap row returned by <code className="bg-card-muted px-1 rounded">GET /wallet/v1/requests/&#123;id&#125;</code> holds only these <code className="bg-card-muted px-1 rounded">status</code> strings: <code className="bg-card-muted px-1 rounded">processing</code> (keep polling), <code className="bg-card-muted px-1 rounded">success</code>, <code className="bg-card-muted px-1 rounded">failed</code> (a 1Click refund/expiry is normalized to <code className="bg-card-muted px-1 rounded">failed</code>; reason in <code className="bg-card-muted px-1 rounded">result.reason</code>), and <code className="bg-card-muted px-1 rounded">needs_review</code>. On a multisig wallet the submit can
 return <code className="bg-card-muted px-1 rounded">pending_approval</code> / <code className="bg-card-muted px-1 rounded">approved</code> / <code className="bg-card-muted px-1 rounded">rejected</code> instead. Do <strong>not</strong> invent synonym
 sets (<code className="bg-card-muted px-1 rounded">settled</code>/<code className="bg-card-muted px-1 rounded">completed</code>/&hellip;) — none of those are emitted.
          </p>
 <p className="text-sm text-foreground">
 <strong><code className="bg-card-muted px-1 rounded">needs_review</code> is terminal but special:</strong>            execution was interrupted or unresolved and the fund state is unknown. Surface it as &ldquo;needs manual
 ...
 Move a token from your Intents balance to <strong>another account&apos;s</strong> Intents balance, gasless, staying <strong>inside</strong> <code className="bg-card-muted px-1 rounded">intents.near</code> &mdash; the recipient is credited there, nothing lands on the public chain. This is <strong>not</strong> a withdrawal: use it when the recipient also holds an Intents balance (e.g. another OutLayer custody wallet); use <code className="bg-card-muted px-1 rounded">/intents/withdraw</code> to deliver to a plain on-chain account instead. NEAR-only (no <code className="bg-card-muted px-1 rounded">chain</code> field); <code className="bg-card-muted px-1 rounded">token</code> is required (to send NEAR, transfer <code className="bg-card-muted px-1 rounded">nep141:wrap.near</code>). The recipient need not exist on-chain.
        </p>
        <SyntaxHighlighter language="bash" style={vscDarkPlus} customStyle={{ borderRadius: '0.5rem', fontSize: '0.875rem' }}>
...
{`curl -s -X POST -H "Content-Type: application/json" \\
 ...
 <div className="bg-destructive/10 border-l-4 border-red-500 p-4 mt-2 mb-4">
 <p className="text-sm text-foreground">
...
{`https://app.outlayer.ai/wallet?key=wk_...`}
 ...
 <p className="text-foreground mb-4">All endpoints except <code className="bg-card-muted px-1 rounded">/register</code> require the <code className="bg-card-muted px-1 rounded">Authorization: Bearer &lt;api_key&gt;</code> header.</p>
 ...
 <tr className="border-b">
 <td className="px-4 py-2">Sign raw EVM transaction <span className="text-faint-foreground">(needs <code className="bg-card-muted px-1 rounded">evm_sign.raw_tx</code>; client serializes &amp; broadcasts)</span></td>
 <td className="px-4 py-2 font-mono">POST</td>
 <td className="px-4 py-2 font-mono text-xs">/wallet/v1/evm/sign-transaction</td>
              </tr>
 <tr className="border-b">
 <td className="px-4 py-2">Sign Solana message <span className="text-faint-foreground">(raw-bytes ed25519, base58 sig; rejects bytes that parse as a tx message)</span></td>
 <td className="px-4 py-2 font-mono">POST</td>
 <td className="px-4 py-2 font-mono text-xs">/wallet/v1/solana/sign-message</td>
              </tr>
 <tr className="border-b">
 <td className="px-4 py-2">Sign Solana transaction <span className="text-faint-foreground">(needs <code className="bg-card-muted px-1 rounded">solana_sign.raw_tx</code>; client sends base64 serialized tx message, assembles &amp; broadcasts)</span></td>
 <td className="px-4 py-2 font-mono">POST</td>
 <td className="px-4 py-2 font-mono text-xs">/wallet/v1/solana/sign-transaction</td>
              </tr>
 <tr className="border-b">
 ...
 <tr className="border-b bg-card-muted/30">
 ...
 Base URL: <code className="bg-card-muted px-1 rounded">https://api.outlayer.ai</code> (mainnet)
          {' · '}
 <code className="bg-card-muted px-1 rounded">https://testnet-api.outlayer.ai</code> (testnet)
        </p>

 <div className="bg-card-muted border-l-4 border-border p-4 text-sm text-foreground">
 ...
 <p className="text-foreground mb-4">
 Move balances between your <strong>public</strong> intents shard, a <strong>confidential</strong> shielded-pool shard, and external chains — same
          TEE-mediated signing, a different shard. The <code className="bg-card-muted px-1 rounded">/wallet/v1/confidential/*</code> routes mirror <code className="bg-card-muted px-1 rounded">/wallet/v1/intents/*</code>. Like all Intents
 flows they are <strong>mainnet-only</strong> — they return <code className="bg-card-muted px-1 rounded">HTTP 503</code> on testnet (no testnet solvers)
          or wherever the deployment has not enabled confidential intents. The confidential shard is the <code className="bg-card-muted px-1 rounded">intents.far</code> contract on a private NEAR
 shard with no public RPC: balances are <strong>real on-chain state</strong> there, just
          not publicly readable. Full integration guide: <a className="text-accent-text underline" href="https://github.com/out-layer/coordinator/blob/main/docs/CONFIDENTIAL_INTENTS.md">
            CONFIDENTIAL_INTENTS.md
          </a>.
        </p>

 <ul className="list-disc list-inside text-foreground space-y-1 mb-4">
 <li><code className="bg-card-muted px-1 rounded">POST /confidential/shield</code> — SHIELD: public intents → confidential (legacy alias <code className="bg-card-muted px-1 rounded">/confidential/deposit</code>, still works)</li>
 <li><code className="bg-card-muted px-1 rounded">POST /confidential/unshield</code> — confidential → public intents</li>
 <li><code className="bg-card-muted px-1 rounded">POST /confidential/withdraw</code> — confidential → external chain (or <code className="bg-card-muted px-1 rounded">chain=&quot;near&quot;</code> for native NEAR delivery via <code className="bg-card-muted px-1 rounded">native_withdraw</code>)</li>
 <li><code className="bg-card-muted px-1 rounded">POST /confidential/transfer</code> — private confidential → confidential transfer</li>
 <li><code className="bg-card-muted px-1 rounded">POST /confidential/swap</code> (+ <code className="bg-card-muted px-1 rounded">/swap/quote</code>, <code className="bg-card-muted px-1 rounded">/withdraw/dry-run</code>) &mdash; on a multisig wallet, like a public swap, approval controls <em>whether</em> it runs (the TEE does not itself re-check the swap&apos;s token/amount against the artifact &mdash; that relies on gateway trust)</li>
 <li><code className="bg-card-muted px-1 rounded">POST /confidential/deposit/cross-chain</code> — cross-chain deposit (via 1Click / NEAR Intents; legacy alias <code className="bg-card-muted px-1 rounded">/confidential/deposit-intent</code>, still works)</li>
 <li><code className="bg-card-muted px-1 rounded">GET /confidential/balance</code> — read confidential balances</li>
        </ul>
 ...
 state on a private shard</strong> (<code className="bg-card-muted px-1 rounded">intents.far</code>)
 ...
 sender/receiver is public, on that chain. <strong>Never hidden:</strong> the shard
            ...
            auditors / law enforcement with a warrant can all see confidential state. <strong>For unlinkability</strong>, fund via cross-chain deposit and exit via
...
curl -s -H "Authorization: Bearer $API_KEY" \\
 ...
 <p className="text-foreground mb-4">
 Permanently delete the wallet&apos;s on-chain NEAR account using the native <code className="bg-card-muted px-1 rounded">DeleteAccount</code> action.
          All remaining native NEAR balance is automatically sent to the beneficiary. All API keys are revoked.
        </p>

 <div className="bg-destructive/10 border-l-4 border-red-500 p-4 mb-4">
 <p className="text-sm text-foreground">
 <strong>Warning:</strong> Only native NEAR tokens are sent to the beneficiary (handled by NEAR&apos;s <code className="bg-destructive/15 px-1 rounded">DeleteAccount</code>).
 ...
 <li>Transfer all FT tokens via <code className="bg-card-muted px-1 rounded">POST /wallet/v1/call</code> with <code className="bg-card-muted px-1 rounded">ft_transfer</code></li>
 <li>Withdraw Intents balances via <code className="bg-card-muted px-1 rounded">POST /wallet/v1/intents/withdraw</code></li>
...
{`{
 ...
 After deletion, the on-chain account no longer exists and all API keys are revoked. Subsequent API requests will return <code className="bg-card-muted px-1 rounded">invalid_api_key</code>.
        </p>
      </section>
...
{`{
 ...
 <thead><tr className="border-b"><th className="text-left py-2 px-3">Field</th><th className="text-left py-2 px-3">Required</th><th className="text-left py-2 px-3">Description</th></tr></thead>
            <tbody>
 <tr className="border-b"><td className="py-2 px-3"><code className="bg-card-muted px-1 rounded">message</code></td><td className="py-2 px-3">Yes</td><td className="py-2 px-3">Text to sign (max 10,000 bytes)</td></tr>
 <tr className="border-b"><td className="py-2 px-3"><code className="bg-card-muted px-1 rounded">recipient</code></td><td className="py-2 px-3">Yes</td><td className="py-2 px-3">Service that will verify the signature (1&ndash;128 chars)</td></tr>
 <tr className="border-b"><td className="py-2 px-3"><code className="bg-card-muted px-1 rounded">nonce</code></td><td className="py-2 px-3">No</td><td className="py-2 px-3">Base64-encoded 32 bytes. Auto-generated if omitted</td></tr>
            </tbody>
          </table>
        </div>
 ...
 identity without RPC: <code className="bg-card-muted px-1 rounded">account_id == hex(public_key_bytes)</code>.
          </p>
        </div>
      </section>
 ...
 The wallet ID is derived from <code className="bg-card-muted px-1 rounded">(account_id, seed, vault_or_none)</code> &mdash; same inputs always produce the same wallet, and different vault scopes legitimately mint independent sub-wallets under the same seed.
          Auth uses NEAR ed25519 signatures on every request instead of stored API keys.
 Seed format: <code className="bg-card-muted px-1 rounded">[a-zA-Z0-9._-]</code>, 1-256 chars.
        </p>
 ...
 Custody wallets (<code className="bg-card-muted px-1 rounded">wk_</code> API key) can also create sub-agents &mdash; just pass your Bearer header to <code className="bg-card-muted px-1 rounded">PUT /wallet/v1/api-key</code> with <code className="bg-card-muted px-1 rounded">seed</code> and <code className="bg-card-muted px-1 rounded">key_hash</code> in body, no NEAR signatures needed.
          </p>
        </div>

 <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
 <div className="border border-border rounded-lg p-4">
 <h4 className="font-semibold text-foreground mb-1">Telegram / Discord Bot</h4>
 <p className="text-xs text-muted-foreground">One NEAR key in env. <code className="bg-card-muted px-0.5 rounded text-xs">seed = SHA256(user_id)</code>. Creates wallets for thousands of users. Zero per-user DB.</p>
          </div>
 <div className="border border-border rounded-lg p-4">
 <h4 className="font-semibold text-foreground mb-1">Web App (OAuth)</h4>
 <p className="text-xs text-muted-foreground">Server has one NEAR key. <code className="bg-card-muted px-0.5 rounded text-xs">seed = SHA256(provider:user_id)</code>. Google login &rarr; instant wallet.</p>
          </div>
 <div className="border border-border rounded-lg p-4">
 <h4 className="font-semibold text-foreground mb-1">Sub-agents</h4>
 <p className="text-xs text-muted-foreground">Parent derives <code className="bg-card-muted px-0.5 rounded text-xs">wk_</code> keys from NEAR key + seed. Sub-agent uses simple Bearer token &mdash; no crypto.</p>
          </div>
        </div>
 ...
 <td className="px-4 py-2">With <code className="bg-card-muted px-1 rounded">ed25519:</code> prefix</td>
...
# No api_key — use Bearer near:... for all requests`}
 ...
 <ul className="list-disc pl-6 text-foreground mb-2 text-sm space-y-1">
 <li>No vault: <code className="bg-card-muted px-1 rounded">auth:&lt;seed&gt;:&lt;timestamp&gt;</code></li>
 <li>With vault: <code className="bg-card-muted px-1 rounded">auth:&lt;seed&gt;:&lt;timestamp&gt;:&lt;vault_id&gt;</code> — vault_id MUST be inside the signed message (not only in JSON), otherwise verify fails with 401.</li>
        </ul>
        <SyntaxHighlighter language="json" style={vscDarkPlus} customStyle={{ borderRadius: '0.5rem', fontSize: '0.875rem' }}>
{`{
  "account_id": "my-bot.near",
 ...
 <div className="bg-card-muted border-l-4 border-border p-4 mb-4 mt-3">
 <p className="text-sm text-foreground">
 <strong>Key lives in the TEE?</strong> The <code className="bg-card-muted px-1 rounded">signature</code> above assumes you hold the NEAR ed25519 key locally. For a wallet whose key lives in OutLayer custody (the TEE), you don&apos;t have the private key &mdash; instead call <code className="bg-card-muted px-1 rounded">POST /wallet/v1/auth-sign</code> with <code className="bg-card-muted px-1 rounded">{`{ "purpose": "bearer", "seed": "<seed>" }`}</code> and it returns the <code className="bg-card-muted px-1 rounded">auth:&lt;seed&gt;:&lt;timestamp&gt;</code> message and signature (signed inside the TEE with a fresh server timestamp) to drop into the token.
          </p>
        </div>

 <h3 className="text-lg font-semibold mt-6 mb-2">Delegate keys for sub-agents</h3>
 <p className="text-foreground mb-2">
 Register a <code className="bg-card-muted px-1 rounded">wk_</code> key hash so a sub-agent can use simple Bearer auth.
 Works from both custody wallets (<code className="bg-card-muted px-1 rounded">Bearer wk_...</code>) and external NEAR accounts (signature in body).
        </p>
        <SyntaxHighlighter language="bash" style={vscDarkPlus} customStyle={{ borderRadius: '0.5rem', fontSize: '0.875rem' }}>
...
# Returns 409 if last active key for the wallet`}
 ...
 Old key access is revoked within 60 seconds (cache TTL). Wallet identity is tied to <code className="bg-card-muted px-1 rounded">(account_id, seed, vault_or_none)</code>, not to which key signs.
        </p>
      </section>
 ...
 <h3 className="font-semibold text-foreground">MPC master secret</h3>
 <p className="text-sm text-foreground">
 ...
 Individual wallet keys are then derived inside the TEE using <code className="bg-card-muted px-1 rounded">HMAC-SHA256(master_secret, &quot;wallet:&#123;id&#125;:&#123;chain&#125;&quot;)</code>.
              The same wallet ID always produces the same addresses across chains.
            </p>
          </div>

 <div className="border-l-4 border-border-strong pl-4">
 <h3 className="font-semibold text-foreground">TEE attestation</h3>
 <p className="text-sm text-foreground">
 ...
 <div className="border-l-4 border-border-strong pl-4">
 <h3 className="font-semibold text-foreground">Policy on-chain</h3>
 <p className="text-sm text-foreground">
 ...
 <div className="border-l-4 border-border-strong pl-4">
 <h3 className="font-semibold text-foreground">Agent compromise recovery</h3>
 <p className="text-sm text-foreground">
...
curl -s https://skills.outlayer.ai/agent-custody/SKILL.md`}
 ...
 <p className="text-foreground mt-2 mb-4">
 ...
 <h4 className="font-semibold text-foreground mb-2">What the skill file covers:</h4>
...
outlayer earnings`}
 ...
 <div className="bg-card-muted border-l-4 border-border p-4 mt-4 mb-4">
 <p className="text-sm text-foreground">
 <strong>How it works:</strong> When logged in with <code className="bg-card-muted px-1 rounded">--wallet-key</code>, the CLI stores the auth type as <code className="bg-card-muted px-1 rounded">wallet_key</code>.
 All contract operations are routed through <code className="bg-card-muted px-1 rounded">POST /wallet/v1/call</code> instead of local transaction signing.
 NEP-413 signatures (used by <code className="bg-card-muted px-1 rounded">secrets update</code>) go through <code className="bg-card-muted px-1 rounded">POST /wallet/v1/sign-message</code>.
          </p>
        </div>

 <h4 className="font-semibold text-foreground mb-2">Supported commands</h4>
 <div className="overflow-x-auto mb-4">
 <table className="min-w-full text-sm border border-border">
 <thead className="bg-card-muted">
              <tr>
 ...
 <th className="px-4 py-2 text-left font-semibold border-b">Status</th>
            ...
            <tbody>
 <tr className="border-b"><td className="px-4 py-2 font-mono">deploy, run, keys, secrets, earnings, versions</td><td className="px-4 py-2 text-foreground">Supported</td></tr>
 <tr><td className="px-4 py-2 font-mono">upload (FastFS)</td><td className="px-4 py-2 text-foreground">Not yet &mdash; requires raw Borsh args</td></tr>
            </tbody>
          </table>
        </div>
      </section>
