  ...
  return (
    <div className="max-w-5xl">
      ...
      <section className="mb-10">
        ...
        <div className="bg-success/10 border-l-4 border-success/60 p-4 mb-6">
        ...
        <div className="bg-info/10 border-l-4 border-info/60 p-4 mb-6">
          <p className="text-sm text-foreground">
        ...
        <div className="bg-card-muted rounded-lg border border-border p-6 mb-6 overflow-x-auto">
          <div className="min-w-[700px]">
            ...
            <div className="grid grid-cols-[1fr_2fr_1fr] gap-0 items-start">
              {/* Agent */}
              <div className="bg-card rounded-lg border-2 border-info/50 p-3 text-center">
                <div className="text-lg mb-1">&#129302;</div>
                <div className="text-xs font-bold text-info">AI Agent</div>
              ...
              {/* Wallet Owner */}
              <div className="bg-card rounded-lg border-2 border-orange-400 p-3 text-center">
                <div className="text-lg mb-1">&#128100;</div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-card rounded-lg border-2 border-purple-400 p-3 text-center">
                <div className="text-lg mb-1">&#9939;&#65039;</div>
      ...
      <section id="multi-chain" className="mb-10 scroll-mt-4">
          ...
          <table className="min-w-full text-sm border border-border">
            ...
            <tbody>
              <tr className="border-b">
                ...
                <td className="px-4 py-2 text-success-text">&#10003; direct to Intents balance</td>
                <td className="px-4 py-2 text-success-text">&#10003; via Intents (gasless)</td>
                <td className="px-4 py-2 text-success-text">&#10003; NEAR address + direct contract calls</td>
              </tr>
              <tr className="border-b">
                <td className="px-4 py-2 font-semibold">Ethereum</td>
                <td className="px-4 py-2 text-success-text">&#10003; cross-chain (1Click)</td>
                <td className="px-4 py-2 text-success-text">&#10003; via Intents (gasless)</td>
                <td className="px-4 py-2 text-success-text">&#10003; shared 0x address + signing via /wallet/v1/evm/* (client broadcasts)</td>
              </tr>
              <tr className="border-b">
              ...
              <tr className="border-b">
                ...
                <td className="px-4 py-2 text-success-text">&#10003; cross-chain (1Click)</td>
                <td className="px-4 py-2 text-success-text">&#10003; via Intents (gasless)</td>
                <td className="px-4 py-2 text-success-text">&#10003; base58 address + signing via /wallet/v1/solana/* (client broadcasts)</td>
              </tr>
              <tr>
                <td className="px-4 py-2 font-semibold">Base, Arbitrum, BSC, Polygon, Optimism, Avalanche</td>
                <td className="px-4 py-2 text-success-text">&#10003; cross-chain (1Click)</td>
                <td className="px-4 py-2 text-success-text">&#10003; via Intents (gasless)</td>
                <td className="px-4 py-2 text-success-text">&#10003; same shared 0x address + /wallet/v1/evm/* signing</td>
              </tr>
            </tbody>
          </table>
        </div>
        ...
        <div className="bg-info/10 border-l-4 border-info/50 p-4 mb-4">
          <p className="text-sm text-foreground">
            <strong>Gasless cross-chain:</strong> When the agent calls <code className="bg-info/15 px-1 rounded">POST /wallet/v1/intents/withdraw</code> to send tokens to Ethereum or Solana,
        ...
        <div className="bg-destructive/10 border-l-4 border-red-500 p-4 mb-4">
          <p className="text-sm text-foreground font-semibold mb-1">⚠️ Only send whitelisted Intents assets &mdash; anything else is lost permanently</p>
          <p className="text-sm text-foreground">
      ...
      <section id="multisig" className="mb-10 scroll-mt-4">
        ...
        <div className="bg-info/10 border-l-4 border-info/50 p-4 mb-4">
          <p className="text-sm text-foreground">
            ...
            swap &mdash; or any NEAR Intents <em>Trusted</em> operation (<code className="bg-info/15 px-1 rounded">swap</code>,
            <code className="bg-info/15 px-1 rounded">confidential</code>, <code className="bg-info/15 px-1 rounded">cross_chain_withdraw</code>) &mdash;
            ...
            Claimable links (<code className="bg-info/15 px-1 rounded">payment_check</code>) are the exception &mdash;
          ...
          <table className="min-w-full text-sm border border-border">
            ...
            <tbody>
              <tr className="border-b">
                ...
                <td className="px-4 py-2 text-success-text">&#10003;</td>
                <td className="px-4 py-2 text-success-text">&#10003; (quorum)</td>
                <td className="px-4 py-2 text-success-text">&#10003;</td>
              </tr>
              <tr>
...
curl -s -X POST -H "Content-Type: application/json" \\
  ...
  "https://api.outlayer.ai/wallet/v1/intents/withdraw"`}
        ...
        <p className="text-foreground mt-3 mb-2">
          <strong>Cross-chain withdrawals: prefer <code className="bg-card-muted px-1 rounded">&quot;async&quot;: true</code>.</strong>{' '}
          The 1Click bridge can take longer than the synchronous response window, so add{' '}
          <code className="bg-card-muted px-1 rounded">&quot;async&quot;: true</code> to the body. The call then returns
          immediately with <code className="bg-card-muted px-1 rounded">status: &quot;processing&quot;</code> and a{' '}
          <code className="bg-card-muted px-1 rounded">poll_url</code>; poll{' '}
          <code className="bg-card-muted px-1 rounded">GET /wallet/v1/requests/&#123;request_id&#125;</code> until terminal.
...
{`https://outlayer.fastnear.com/wallet?key=wk_...`}
      ...
      <section id="api-reference" className="mb-10 scroll-mt-4">
        ...
        <div className="overflow-x-auto mb-4">
          <table className="min-w-full text-sm border border-border">
            ...
            <tbody>
              ...
              <tr className="border-b bg-info/10/30">
        ...
        <div className="bg-warning/10 border-l-4 border-warning/50 p-4 text-sm text-foreground">
          ...
          endpoint — namely{' '}
          <code className="bg-card-muted px-1 rounded">/wallet/v1/intents/*</code>{' '}
          ...
          <code className="bg-card-muted px-1 rounded">/wallet/v1/confidential/*</code> routes.
      ...
      <section id="confidential-intents" className="mb-10 scroll-mt-4">
        ...
        <p className="text-foreground mb-4">
          ...
          <code className="bg-card-muted px-1 rounded">/wallet/v1/confidential/*</code> routes mirror{' '}
          <code className="bg-card-muted px-1 rounded">/wallet/v1/intents/*</code>. Like all Intents
          flows they are <strong>mainnet-only</strong> — they return{' '}
          <code className="bg-card-muted px-1 rounded">HTTP 503</code> on testnet (no testnet solvers)
          or wherever the deployment has not enabled confidential intents. The confidential shard is the{' '}
          <code className="bg-card-muted px-1 rounded">intents.far</code> contract on a private NEAR
          ...
          <a className="text-accent-text underline" href="https://github.com/out-layer/coordinator/blob/main/docs/CONFIDENTIAL_INTENTS.md">
        ...
        <p className="text-foreground mb-4">
          ...
          <code className="bg-card-muted px-1 rounded">request_id</code> with status{' '}
          <code className="bg-card-muted px-1 rounded">pending_deposit</code>; poll{' '}
          <code className="bg-card-muted px-1 rounded">GET /wallet/v1/requests/&#123;id&#125;</code> until terminal.
        </p>
  ...
  "nonce": "base64-encoded-32-bytes"
        ...
        <div className="bg-info/10 border-l-4 border-info/50 p-4 mb-4">
          <p className="text-sm text-foreground">
            ...
            identity without RPC: <code className="bg-info/15 px-1 rounded">account_id == hex(public_key_bytes)</code>.
          </p>
        </div>
      </section>
      ...
      <section id="deterministic-wallets" className="mb-10 scroll-mt-4">
        ...
        <div className="bg-warning/10 border-l-4 border-yellow-500 p-4 mb-6">
          <p className="text-sm text-foreground">
...
{`{
  ...
  "vault_id": "vault.my-bot.near"   // optional; include in signed message too
        ...
        <div className="bg-info/10 border-l-4 border-info/50 p-4 mb-4 mt-3">
          <p className="text-sm text-foreground">
            <strong>Key lives in the TEE?</strong> The <code className="bg-info/15 px-1 rounded">signature</code> above assumes you hold the NEAR ed25519 key locally. For a wallet whose key lives in OutLayer custody (the TEE), you don&apos;t have the private key &mdash; instead call <code className="bg-info/15 px-1 rounded">POST /wallet/v1/auth-sign</code> with <code className="bg-info/15 px-1 rounded">{`{ "purpose": "bearer", "seed": "<seed>" }`}</code> and it returns the <code className="bg-info/15 px-1 rounded">auth:&lt;seed&gt;:&lt;timestamp&gt;</code> message and signature (signed inside the TEE with a fresh server timestamp) to drop into the token.
          </p>
        </div>
...
outlayer earnings`}
        ...
        <div className="bg-info/10 border-l-4 border-info/50 p-4 mt-4 mb-4">
          <p className="text-sm text-foreground">
            <strong>How it works:</strong> When logged in with <code className="bg-info/15 px-1 rounded">--wallet-key</code>, the CLI stores the auth type as <code className="bg-info/15 px-1 rounded">wallet_key</code>.
            All contract operations are routed through <code className="bg-info/15 px-1 rounded">POST /wallet/v1/call</code> instead of local transaction signing.
            NEP-413 signatures (used by <code className="bg-info/15 px-1 rounded">secrets update</code>) go through <code className="bg-info/15 px-1 rounded">POST /wallet/v1/sign-message</code>.
          </p>
        </div>
        ...
        <div className="overflow-x-auto mb-4">
          <table className="min-w-full text-sm border border-border">
            ...
            <tbody>
              <tr className="border-b"><td className="px-4 py-2 font-mono">deploy, run, keys, secrets, earnings, versions</td><td className="px-4 py-2 text-success-text">Supported</td></tr>
              <tr><td className="px-4 py-2 font-mono">upload (FastFS)</td><td className="px-4 py-2 text-warning">Not yet &mdash; requires raw Borsh args</td></tr>
            </tbody>
          </table>
        </div>
      </section>
