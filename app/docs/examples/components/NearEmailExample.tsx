...
export function NearEmailExample() {
 ...
 <strong>Live at:</strong> <a href="https://near.email" target="_blank" rel="noopener noreferrer" className="underline hover:text-accent-text">
            near.email
          </a>
...
Private Key Derivation (OutLayer TEE, requires master secret):
 ...
 <h5 className="font-semibold text-foreground mb-2">Payment Key Mode</h5>
 <ul className="text-sm text-foreground space-y-1 list-disc list-inside">
