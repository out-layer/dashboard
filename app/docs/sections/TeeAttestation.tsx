      ...
      <div className="space-y-8">
        ...
        <section id="what-is-tee">
          ...
          <div className="bg-info/10 border-l-4 border-info/60 p-4 my-4">
            <p className="text-info font-semibold mb-2">Why This Matters:</p>
        ...
        <section id="worker-registration">
          ...
          <div className="bg-info/10 border-l-4 border-info/60 p-4 my-4">
            <p className="text-info font-semibold mb-2">Register Contract:</p>
            ...
            <div className="bg-card rounded p-2 font-mono text-sm">
              <p className="text-info"><strong>Testnet:</strong> <code className="text-orange-600">worker.outlayer.testnet</code></p>
              <p className="text-info"><strong>Mainnet:</strong> <code className="text-orange-600">worker.outlayer.near</code></p>
            </div>
          ...
          <div className="bg-card border-2 border-purple-300 rounded-lg p-6 my-4">
              ...
              <li className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-foreground text-sm">
                    ...
                    <code className="bg-card-muted px-1 rounded">resolve_execution</code> to finalize execution results.
          ...
          <div className="bg-warning/10 border-l-4 border-yellow-500 p-4 my-4">
            <p className="text-warning font-semibold mb-2">What are the 5 TDX Measurements?</p>
        ...
        <section id="post-quantum-keys">
          ...
          <div className="bg-info/10 border-l-4 border-info/50 p-4 my-4">
            <p className="text-info font-semibold mb-2">How the key is bound to the enclave</p>
            <p className="text-info text-sm">
              Because an ML-DSA-65 public key (1952 bytes) doesn&apos;t fit in the quote&apos;s{' '}
              <code className="bg-card/60 px-1 rounded">report_data</code> field, its{' '}
          ...
          <p className="text-foreground text-sm mb-4">
            Live on mainnet: <code className="bg-card-muted px-1 rounded">worker.outlayer.near</code>{' '}
            signs <code className="bg-card-muted px-1 rounded">resolve_execution</code> with an{' '}
            <code className="bg-card-muted px-1 rounded">ml-dsa-65:</code> key. This hardens the trust
        ...
        <section id="execution-attestation">
          ...
          <div className="bg-card border-2 border-success/40 rounded-lg p-6 my-4">
            <h4 className="text-lg font-semibold text-success-text mb-3">What Gets Attested:</h4>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-success/10 p-3 rounded">
                <p className="font-semibold text-success-text mb-1">📋 Source Code</p>
                <p className="text-success-text text-sm">
                  GitHub repository URL and exact commit hash that was compiled.
                </p>
              </div>
              <div className="bg-success/10 p-3 rounded">
                <p className="font-semibold text-success-text mb-1">🗜️ WASM Hash</p>
                <p className="text-success-text text-sm">
                  SHA256 of the compiled WebAssembly binary that was executed.
                </p>
              </div>
              <div className="bg-success/10 p-3 rounded">
                <p className="font-semibold text-success-text mb-1">📥 Input Hash</p>
                <p className="text-success-text text-sm">
                  SHA256 of the input data sent to the WASM program.
                </p>
              </div>
              <div className="bg-success/10 p-3 rounded">
                <p className="font-semibold text-success-text mb-1">📤 Output Hash</p>
                <p className="text-success-text text-sm">
                  SHA256 of the output returned by the WASM execution.
                </p>
              </div>
              <div className="bg-success/10 p-3 rounded">
                <p className="font-semibold text-success-text mb-1">🔐 Worker Measurement</p>
                <p className="text-success-text text-sm">
                  TDX measurement identifying which registered worker performed the execution.
                  Workers are registered with{' '}
                  <a href="/docs/trust-verification#measurements" className="underline hover:text-success-text">all 5 TDX measurements</a>.
                </p>
              </div>
              <div className="bg-success/10 p-3 rounded">
                <p className="font-semibold text-success-text mb-1">🔏 TDX Quote</p>
                <p className="text-success-text text-sm">
        ...
        <section id="trust-model">
          ...
          <p className="text-foreground mb-3">
            ...
            <code className="bg-card-muted px-1 rounded">wasm_hash</code> — a SHA256 of the exact bytes that ran.
          ...
          <div className="bg-warning/10 border-l-4 border-yellow-500 p-4 my-4">
            <p className="text-warning font-semibold mb-2">The anchor is the wasm_hash, not a repo + commit</p>
            <p className="text-warning text-sm">
              ...
              <code className="bg-card px-1 rounded">wasm_hash</code> cannot. Trust follows the bytes, addressed
              by their hash.
            </p>
          </div>
          ...
          <div className="bg-card border-2 border-purple-300 rounded-lg p-4 my-4">
          ...
          <div className="bg-info/10 border-l-4 border-info/60 p-4 my-4">
            <p className="text-info font-semibold mb-2">Is the consumer &quot;privy&quot; to verification?</p>
            <p className="text-info text-sm">
        ...
        <section id="data-freshness">
          ...
          <div className="bg-card border-2 border-success/40 rounded-lg p-4 my-4">
        ...
        <section id="verification-process">
          ...
          <div className="bg-card border-2 border-info/40 rounded-lg p-6 my-4">
            <h4 className="text-lg font-semibold text-info mb-3">How to Verify an Attestation:</h4>

            <div className="space-y-4">
              <div className="border-l-4 border-info/60 pl-4">
                ...
                <p className="text-foreground text-sm mb-2">
                  ...
                  <code className="bg-card-muted px-1 rounded">GET /public/collateral?fmspc=…&amp;at=…</code>, so an
              ...
              <div className="border-l-4 border-info/60 pl-4">
                ...
                <p className="text-foreground text-sm mb-2">
                  ...
                  (<code className="bg-card-muted px-1 rounded">worker.outlayer.near</code>) whether they are approved:{' '}
                  <code className="bg-card-muted px-1 rounded">is_measurements_approved</code>. A genuine TEE running
                  someone else&apos;s code fails here. All five measurements are checked —{' '}
                  <a href="/docs/trust-verification#measurements" className="underline hover:text-accent-text">MRTD + RTMR0-3</a>.
                </p>
              </div>
              ...
              <div className="border-l-4 border-info/60 pl-4">
                ...
                <p className="text-foreground text-sm mb-2">
                  ...
                  <a href="#task-hash" className="underline hover:text-accent-text">Task Hash section</a> below.
                </p>
        ...
        <section id="task-hash">
          ...
          <div className="bg-success/10 border-l-4 border-success/60 p-4 my-4">
            <p className="text-success-text font-semibold mb-2">The Solution:</p>
            <p className="text-success-text text-sm mb-2">
          ...
          <div className="bg-card border-2 border-purple-300 rounded-lg p-6 my-4">
            ...
            <div className="bg-warning/10 border border-warning/40 rounded p-3 mb-3">
              <p className="text-warning text-sm font-semibold mb-1">Important Details:</p>
          ...
          <div className="bg-info/10 border-l-4 border-info/60 p-4 my-4">
            <p className="text-info font-semibold mb-2">Interactive Verification in Dashboard:</p>
            <p className="text-info text-sm mb-2">
            ...
            <ol className="list-decimal list-inside space-y-1 text-info text-sm ml-2">
          ...
          <div className="bg-card border-2 border-border-strong rounded-lg p-4 my-4">
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="bg-success/10 border border-success/30 rounded p-2">
                <p className="text-success-text font-semibold">✓ Defense (with Task Hash):</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-4">
            <div className="bg-card border-2 border-success/30 rounded-lg p-4">
              <div className="flex items-center mb-2">
                ...
                <h4 className="font-semibold text-success-text">Hardware Isolation</h4>
              </div>
              <p className="text-foreground text-sm">
            ...
            <div className="bg-card border-2 border-success/30 rounded-lg p-4">
              <div className="flex items-center mb-2">
                <span className="text-2xl mr-2">🔐</span>
                <h4 className="font-semibold text-success-text">Intel Signature</h4>
              </div>
              <p className="text-foreground text-sm">
            ...
            <div className="bg-card border-2 border-success/30 rounded-lg p-4">
              <div className="flex items-center mb-2">
                ...
                <h4 className="font-semibold text-success-text">Tamper-Proof</h4>
              </div>
              <p className="text-foreground text-sm">
            ...
            <div className="bg-card border-2 border-success/30 rounded-lg p-4">
              <div className="flex items-center mb-2">
                <span className="text-2xl mr-2">🔍</span>
                <h4 className="font-semibold text-success-text">Verifiable by Anyone</h4>
              </div>
              <p className="text-foreground text-sm">
            ...
            <div className="bg-card border-2 border-success/30 rounded-lg p-4">
              <div className="flex items-center mb-2">
                <span className="text-2xl mr-2">📜</span>
                <h4 className="font-semibold text-success-text">Code Transparency</h4>
              </div>
              <p className="text-foreground text-sm">
            ...
            <div className="bg-card border-2 border-success/30 rounded-lg p-4">
              <div className="flex items-center mb-2">
                <span className="text-2xl mr-2">🔗</span>
                <h4 className="font-semibold text-success-text">Blockchain Anchoring</h4>
              </div>
              <p className="text-foreground text-sm">
        ...
        <section id="dashboard-verification">
          ...
          <div className="bg-card border-2 border-orange-300 rounded-lg p-6 my-4">
          ...
          <div className="bg-success/10 border-l-4 border-success/60 p-4 my-4">
            <p className="text-success-text font-semibold mb-2">Interactive Verification:</p>
            <p className="text-success-text text-sm">
          ...
          <div className="bg-info/10 border-l-4 border-info/60 p-4 my-4">
            <p className="text-info font-semibold mb-2">Need Help?</p>
            <p className="text-info text-sm">
