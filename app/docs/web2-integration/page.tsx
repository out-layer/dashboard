    ...
    <div className="prose prose-lg max-w-none">
      ...
      <section className="mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
          <div className="border-2 border-success/30 rounded-lg p-5 bg-success/10">
            <div className="text-2xl mb-2">⚡</div>
            <h4 className="font-semibold text-success-text mb-2">Sub-Second Response</h4>
          ...
          <div className="border-2 border-info/30 rounded-lg p-5 bg-info/10">
            <div className="text-2xl mb-2">💵</div>
            <h4 className="font-semibold text-info mb-2">USDC Payments</h4>
            <p className="text-sm text-foreground">
          ...
          <table className="min-w-full divide-y divide-border text-sm">
            ...
            <tbody className="bg-card divide-y divide-border">
              <tr>
                ...
                <td className="px-3 py-2 text-success-text">Yes</td>
